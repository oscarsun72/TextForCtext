...
'                AppActivate word.ActiveWindow.Caption
            ...
            If Not flgPaste Then
                ...
                Dim guaKeyword
                guaKeyword = Array(VBA.ChrW(-10119), VBA.ChrW(-8742), VBA.ChrW(-30233), VBA.ChrW(-10164), VBA.ChrW(-8698), VBA.ChrW(-31827), VBA.ChrW(-10132), VBA.ChrW(-8313), VBA.ChrW(20810), VBA.ChrW(-10167), VBA.ChrW(-8698), VBA.ChrW(-26587), VBA.ChrW(21093), VBA.ChrW(14615), VBA.ChrW(20089), VBA.ChrW(26080), "妄", VBA.ChrW(26083), "濟" _
...
'                        rng.Select '偵錯用
                        ...
                        If Not rng.Next Is Nothing Then
                            If rng.Next.Characters.Count > 0 Then
                                ...
                                If Keywords.易學KeywordsToMark_ExamFollowedAvoid.Exists(e) Then
...
checkPrevious:
                                    If Not rng.Previous Is Nothing Then
                                        ...
                                        If rng.Previous.Characters.Count > 0 Then
                                            ...
                                            If Keywords.易學KeywordsToMark_ExamPrecededAvoid.Exists(e) Then
...
'                                                    Next eArrKey
                                                ...
                                                If examOK Then '合格才標識
                                                    With rng
                                                        ...
                                                        If processCntr Mod 100 = 0 Then SystemSetup.playSound 1 '播放音效以免誤以為當了
