    ...
    易學Keywords_ToMark = Array("易", "周易", "易經", "大易", "五經", "六經", "七經", "十三經", "蓍", _
        ...
        "初九", "九二", "九三", "九四", "九五", "上九", VBA.ChrW(19972) & "九", "用九", "初六", "六二", "六三", "六四", "六五", "上六", "用六", "河圖", "洛書", "太極", "無極", "兩儀", _
            "象曰", "〈象〉曰", "象日", "象云", "象傳", "大象", "大" & VBA.ChrW(-10145) & VBA.ChrW(-9156), "小象", "象義", "四象", VBA.ChrW(-10145) & VBA.ChrW(-9156), "象：", "象文", "彖", _
             "艮其背", "艮", "頤", "同人于宗", "同人", "坎", "中孚", "兌", VBA.ChrW(20817), VBA.ChrW(20810), "蠱", "姤", "巽", VBA.ChrW(14514), "剝", VBA.ChrW(21093), "遯世無悶", "遯世" & ChrW(26080) & "悶", "遯", "大壯", "明夷", "明" & VBA.ChrW(-10171) & VBA.ChrW(-8739), "小畜", "大畜", "萃", "蹇", "渙", VBA.ChrW(28067), "睽", "暌", "歸妹", "小過", "大有", "大過", "〈泰〉", "〈否〉", "〈損〉", "〈益〉", "〈屯", "蒙〉", VBA.ChrW(-10132) & VBA.ChrW(-8313) & "〉", "豫大", "豫", "〈旡妄〉", "〈復〉", "〈震〉", "〈需〉", "老陰", "老" & VBA.ChrW(-27006), "老陽", "少陰", "少" & VBA.ChrW(-27006), "少陽", "繇辭", "繇詞", _
            "咎", "咸恒", "咸恆", "大衍", "咸之九五", "禴祭", "東鄰", "東" & VBA.ChrW(-26973), "禴" & VBA.ChrW(-10155) & VBA.ChrW(-8630), "禴" & VBA.ChrW(-10131) & VBA.ChrW(-8268), "善不積", "天下雷行", _
