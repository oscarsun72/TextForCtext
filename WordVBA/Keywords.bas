...
Property Get 易學KeywordsToMark_Exam_Preceded_Avoid() As Scripting.Dictionary
    If preceded_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("尤", "容", "未", "不", "極", "甚", "貿", "交", "物", "變", "或可", "鄙", "博", "辟", "平", "慢", "俗", "坦", "難", "脫", "流", "樂", "革", "更", "簡", "白居", "居", "淺", "輕", "險", "相", "難行", "世", "易", "所", _
            ...
            "新陳相", "捷最", "上下互", "肯改", "崔伯", "劉", "奢", "覆墜之", "知其難", "得失之", "有不善未嘗不知", "事難慮", "事久則慮", "勢固", "立門戶也", "立門" & VBA.ChrW(25143) & "也", _
            "聽之者", "壞真從", "喪失之", "為惡則", "言兮毋", "尋又", "愉和", "壞" & VBA.ChrW(30494) & "從", "厚和", "誠不為", "可", "人欲", "市", "輒", VBA.ChrW(-28903), "遽", "過於和", "平心", "大樂必", _
            "君便道", "知其至", "立節行、", "無身過", "至之亦", "無口過", "心便", "其正外", "盜固", "立節行", "圖難於其", "成誦", "月日時無", "使聽者之", "嶽號五", "鮮不忽", "而外和", "致終身之", "以天下與人", "詰王與")
        ...
        dict.Add "咎", Array("欲", "得", "歸", "不", "過", "追", "休", "厥", "自", "引", "殃", "何", "晁無", "晁丈無", "足", "受其", "重其", "任其", "論者皆", _
            "專", "示", "將有", "怨", "屈宜", "適逢其", "乖忤之", "庸得免", "微我有") ', "知休", "卜休", "知人休", "能知休", "身之休"
        
        dict.Add "無妄", Array("真實", "誠而", "至善", "實有而")
...
Property Get 易學KeywordsToMark_Exam_Followed_Avoid() As Scripting.Dictionary
    If followed_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("簀", "牙", "之以書契", "安居士", "幟", "轍", "厭", "水", "州", "順鼎", "破", "開罐", "筋", "姓", "名之日", "卜生", "堂", "科", _
            "守", "棺", "看", "積", "容", "衣", "折", "萌", "葬", "獄", "其處", "名者", "曉", "得消散", "慢", "熔", "忘", "物", "易", "俗", "差", "陷", "肆", "下手", "渡", "紙易之", "腐敗", _
             "手", "如反", "善作詩", "地皆然", "治也", "位之事", "直子諒", "學而", "著火", "於噴", "元善", "之以羊", "其田疇", "世之後", "以走險", "不能堪", "直不足言", "以動人", "得鹵", "十姓", "易其形者為", "言則難", "視之", _
            "為物誘", "搖而難", "動難安", "昏而難", "君之位", "其好色", "字希", "直慈良", "天常", "見者", "代而改", "於混亂", VBA.ChrW(24422) & "章", "彥章", "以挺", "於近者。非知言者也", "於近者非知言者也", "出議論", "退之節", "玄光", "梓宮", "知由單", "占偶書", "世而後", "於怠惰", _
            "如翻", "如拾", "子而", "肩輿", "以生怨", "以汗澤", "地皆安", "為求福", "為肉黍", "則學者將", "位之說", "為黍肉", "以及難", "其惡", "事爾", "但不香", "於移奪者", "知而不知", "舊榜", "得汩沒", "子所作", "易生粉", "發酸", "如燎毛", "置其次", "至沮喪", "驚也")
        
        dict.Add "周易", Array("癡")
        dict.Add "卦", Array("陣", "橋", "建築")
        dict.Add "筮", Array("仕")
        dict.Add "乾", Array("淨", "隆", "寧", "祐", "餱", _
        ...
        dict.Add "大有", Array("功", "力", "病", "父風", "警省", "逕庭", "李僧", "所瀦", "事在", "大積", "稽驗")
        dict.Add "無妄", Array("想")
...
Property Get 易學KeywordsToMark_Exam_InPhrase_Avoid() As Scripting.Dictionary
    If inPhrase_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("李易安", "居易錄", "蘇易簡", "杜易簡", "張易之", "此易事", "人易老", "人易去", "兩易其任", "最易淆", "以賢易不肖", "以治易亂", _
            ...
            "其得易失", "以易心", "以易處之", "則易位", "反易天明", "因易其韻", "以縉儒者易之", "因改易本文而", "尺寸易以", "客易主位", "願亦易愜", "則易發", "根易發", "客易位", "以改易之", "主易位", "必易疑", "易信必易疑", "平實易知", "簡要易行", _
            "傷易則誕", "而易陵", "皆易之以", "事在易而求", "儉則易足", "過易辭", "可以易位", "曾易占", "不能易焉", "深德易占", "後易占", "將易吾", "者易犯", "狹則易足", "悔易勿輕踵", "智易窮", "何以易窮", "更有易見者", "而易散", _
            "至易事", "得到易處", "曉然易見", "喪易而文", "易位易君", "得而易者", "改柯易葉", "敢易也", "河東、易定", "易定、魏博", "豈易堪此", "以為易知", "河東易定", "脆易折", "彰癉易位", "易定魏博", "柔易治", "最易生", _
            "疾易作", "病易除", "互易注文", "其易寧戚", "其易，寧", "無難，是以易也", "人易從", "何以易生", "易放而難操", "氣易乘", "物亦易給", "錢差易 ", "言易墜", "所以易放", "者易直", "是易言也", "須易之", "之易以仰測", "蓴絲之易", "皆易黃屋", "皆易" & ChrW(-24892) & "屋", "時易以新", _
            "思以易天下", "心易衰", "則易使", "之易其言", "不能易君子", "事易王", "終以為易而又", "運於掌言易也", "運於掌，言易也", "終以為易，而又", "謀易太子", "侮易承業", "卑近易行", "經師易獲", "成易具", "綿布易之", "勃然易動", "布相易云", "浴易服", "惡易敗", "一易根", "荄於易地", "三易其音", _
            "因易名曰", "以字易名", "婿易見", "合而易離", VBA.ChrW(22779) & "易見", "所賤易所貴", "敢易乎", "食而易得", "籠易制", "仁民易而", "差錯故易說", "差錯，故易說", "論人易矣", "故易辨也", "不易長", "惡幾易熾", "和易近人", "以日易月", "大樂必易", "以之易業", "以之易用", "不欲易也", "基而易舊", _
            ...
            "豈易說", "人人易知", "何言之易也", "人易知焉", "華飾者易于近名", "則易以興起", "而其易明" & VBA.ChrW(-10175) & VBA.ChrW(-8614))
        ...
        dict.Add "同人", Array("底同人不", "不同人生", "不同人能", "皆指同人，未知", "要之以己同人則", "之不同人得其", "不同人字")
        ...
        dict.Add "小過", Array("忘小過以成", VBA.ChrW(14592) & "小過以成", "雖小過而")
