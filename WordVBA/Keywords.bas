...
Property Get 易學KeywordsToMark() As Variant 'string()因為 Array Returns a Variant containing an array,所以不能寫成 as string()
    易學KeywordsToMark = Array("易", "周易", "易經", "大易", "五經", "六經", "七經", "十三經", "蓍", _
        ...
        "河圖", "洛書", "太極", "無極", "兩儀", _
            "象曰", "〈象〉曰", "象日", "象云", "象傳", "〈大象〉", "小象", "象義", "四象", VBA.ChrW(-10145) & VBA.ChrW(-9156), "彖", _
             "艮其背", "艮", "頤", "同人于宗", "同人", "坎", "中孚", "兌", "蠱", "姤", "巽", VBA.ChrW(14514), "剝", VBA.ChrW(21093), "遯世無悶", "遯世" & ChrW(26080) & "悶", "遯", "大壯", "明夷", "明" & VBA.ChrW(-10171) & VBA.ChrW(-8739), "小畜", "大畜", "萃", "蹇", "渙", VBA.ChrW(28067), "睽", "暌", "歸妹", "小過", "大有", "大過", "〈泰〉", "〈否〉", "〈損〉", "〈益〉", "〈屯〉", "豫", "〈旡妄〉", "〈復〉", "〈震〉", "〈需〉", _
            "老陰", "老陽", "少陰", "少陽", "繇辭", "繇詞", _
            "咎", "咸恒", "咸恆", _
...
Property Get 易學KeywordsToMark_ExamPrecededAvoid() As Scripting.Dictionary
    ...
    dict.Add "剝", Array("可", "刻", "褫", "皴", "為之解", "歲蹇", "石斷")
    dict.Add VBA.ChrW(21093), Array("可", "刻", "褫", "為之解", "歲蹇", "石斷")
    dict.Add "頤", Array("周敦", "程", "朵", "濬", "面豐", "筆支", "頂至", "泗交")
    dict.Add VBA.ChrW(-26587), Array("周敦", "程", "朵", "筆支", "頂至")
    dict.Add "巽", Array("李", "翟公", "傅", "家之")
    dict.Add VBA.ChrW(14514), Array("李", "翟公", "傅", "家之")
    ...
    dict.Add "象云", Array("皇", "光景氣")
    dict.Add "文言", Array("與上")
    dict.Add "筮", Array("初", "再")
    dict.Add "咎", Array("歸", "過", "追", "休", "自", "引", "殃", "何", "晁無", "晁丈無", "專", "將有", "怨") ', "知休", "卜休", "知人休", "能知休", "身之休"
...
Property Get 易學KeywordsToMark_ExamFollowedAvoid() As Scripting.Dictionary
    ...
    dict.Add "易", Array("簀", "牙", "之以書契", "安居士", "幟", "轍", "厭", "水", "州", "順鼎", "破", "開罐", "筋", "姓", "名之日", "卜生", "堂", "科", _
        "守", "棺", "看", "積", "容", "萌", "得消散", "慢", "熔", "忘", "物", "易", "俗", "差", "陷", "肆", "下手", "渡", "紙易之", "腐敗", _
         "手", "如反", "善作詩", "著火", "於噴", "以走險", "不能堪", "名者", "曉", "得鹵", "十姓", "易其形者為", "言則難", "視之", _
        "搖而難", "昏而難", "字希", "見者", "出議論", "退之節", "玄光", "梓宮", "知由單", _
        "如翻", "如拾", "子而", "肩輿", "事爾", "但不香", "知而不知", "舊榜", "得汩沒", "子所作", "易生粉", "發酸")
    ...
    dict.Add "剝", Array("落", "春" & VBA.ChrW(-31631), "春蔥", "芋", "削", "民", "蝕", "泐", "落", "去腸", "人面", "婦人衣", "而取之")
    dict.Add VBA.ChrW(21093), Array("落", "春" & VBA.ChrW(-31631), "春蔥", "芋", "削", "民", "蝕", "泐", "落", "去腸", "人面", "婦人衣", "而取之")
    dict.Add "蹇", Array("諤", "驢", "材望", "毅然", "已莫")
    dict.Add "渙", Array("然", "散", "遂踰")
    dict.Add VBA.ChrW(28067), Array("然", "散", "遂踰")
    dict.Add "頤", Array("和園", "正叔", "字正", "茂叔", "字茂", "指氣使", "庵", "菴", "盦", "下有皮")
    dict.Add VBA.ChrW(-26587), Array("和園", "正叔", "字正", "茂叔", "字茂", "下有皮")
    dict.Add "萃", Array("於此", "此書", "于一", "古人", "之成", "其家", "江", "諸庫", "為一書")
    ...
    dict.Add "坎", Array("鼓")
    dict.Add "遯", Array("跡", VBA.ChrW(-28679), "世修真")
    dict.Add "小畜", Array("集")
...
Property Get 易學KeywordsToMark_ExamInPhraseAvoid() As Scripting.Dictionary
    ...
    dict.Add "易", Array("李易安", "居易錄", "蘇易簡", "杜易簡", "張易之", "此易事", "人易老", "人易去", "兩易其任", _
        "江山易主", "深耕易耨", "豈易逢", "後易為", "人而易私", "人而易" & ChrW(-10155) & ChrW(-8352), "以易此", "無以易也", "延易府", "皮易布", "金易一", "名易知", "雖易得", "誠至易", "則易束", "者易窺", "置易制", "難、易相", "事易行", "今易以冠服", "俱易以", "易知也", "市易法", "可以易一飽", "賈易不", "和易之氣", _
        "而易見", "而易起", "而易晦", "不能易也", "最易得", "亢易招", "以易鹽米", "頓易故", "谿易雨", "者易訓", "心易偏", "平心易氣", "故其說易差", "始易為力", "乃易合", "而易彼", "慢而易之", "而易治", "樂易之", "視而易之", _
        "以易心", "以易處之", "因易其韻", "以縉儒者易之", "因改易本文而", "則易發", "根易發", "客易位", "主易位", _
        "而易陵", "儉則易足", "者易犯", "狹則易足", "智易窮", "何以易窮", "更有易見者", "而易散", _
