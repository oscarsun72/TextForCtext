...
Property Get 易學Keywords_ToMark() As Variant 'string()因為 Array Returns a Variant containing an array,所以不能寫成 as string()
    易學Keywords_ToMark = Array("易", "周易", "易經", "大易", "五經", "六經", "七經", "十三經", "蓍", _
        ...
        "初九", "九二", "九三", "九四", "九五", "上九", VBA.ChrW(19972) & "九", "用九", "初六", "六二", "六三", "六四", "六五", "上六", "用六", "河圖", "洛書", "太極", "無極", "兩儀", _
            "象曰", "〈象〉曰", "象日", "象云", "象傳", "大象", "大" & VBA.ChrW(-10145) & VBA.ChrW(-9156), "小象", "象義", "四象", "象：", "象文", "彖", _
            ...
            "咎", "咸恒", "咸恆", "大衍", "咸之九五", "禴祭", "東鄰", "東" & VBA.ChrW(-26973), "禴" & VBA.ChrW(-10155) & VBA.ChrW(-8630), "禴" & VBA.ChrW(-10131) & VBA.ChrW(-8268), "善不積", "天下雷行", "號咷", _
        "無妄", VBA.ChrW(26080) & VBA.ChrW(-10171) & VBA.ChrW(-8522), VBA.ChrW(26080) & "妄", "無咎", VBA.ChrW(26080) & "咎", "天咎", "允升", "屯其膏", "豐亨", "終難", "知幾其神", "有子考", "有子攷", "不易乎世", "不易乎" & VBA.ChrW(21323), "不易乎" & VBA.ChrW(19991), "不成乎名", "天一地二", "蒞眾", VBA.ChrW(-31867) & "眾", VBA.ChrW(-31867) & VBA.ChrW(-30650), "蒞" & VBA.ChrW(-30650), "幹父", "裕父", "係遯", "甘臨", "翰音", _
        "隨時之義", "庖有魚", "包有魚", "精義入神", "豶豕", "童牛", "承之羞", "雷在天上", "錫馬", "蕃庶", "晝日", "三接", "懲忿", "窒欲", "窒慾", "懲窒", "敬以直內", "義以方外", "迷後得主", "利西南", "品物咸章", "天下大行", "益動而", "日進無疆", "日進" & VBA.ChrW(26080) & "疆", "頻巽", "頻" & VBA.ChrW(14514), "豚魚", "頻復", "閑邪", "存誠", "乾乾", "悔吝", "憧憧", "類萬物", VBA.ChrW(-10139) & VBA.ChrW(-8938) & "萬物", VBA.ChrW(-10139) & VBA.ChrW(-8937) & "萬物", "柔順利貞", VBA.ChrW(-10163) & VBA.ChrW(-9167) & "順利貞", "比之匪人", "履貞", "貞厲", "履道坦坦", "貞吉", "貞凶", "直方", "木上有水", "勞民勸相", "索而得", "貞不字", "立成器", "與地之", _
        "無悶", VBA.ChrW(26080) & "悶", "悔亡", "悔" & VBA.ChrW(20158), "悔" & VBA.ChrW(20838), "時義", "健順", "內健而外順", "內健外順", "外順而內健", "外順內健", "易簡", "易" & VBA.ChrW(-10153) & VBA.ChrW(-9007), "敦復", "開物成務", "窮神知化", "研幾極深", "極深研幾", "見善則遷", "有過則改", "遷善改過", "夕惕", "惕若", "一陰一陽", "我有好爵", "言有序", "有聖人之道四", "長子帥師", "弟子輿尸", "日用而不知", "日用不知", "之道鮮", "原始反終", "寂然不動", "感而遂通", "朋從", "朋盍", "容民畜眾", "容民畜" & VBA.ChrW(-30650), "養正", "養賢", "知臨", "臨大君", "默而成之", VBA.ChrW(-24871) & "而成之", "不言而信", "存乎德行", "通天下之志", "履正", "繼之者善", "仁者見之", "知者見之", "智者見之", "撝謙", VBA.ChrW(-10114) & VBA.ChrW(-9019) & "謙", "理財", "正辭", "禁民為非", _
        "大貞", "小貞", "帝出乎震", "帝出於震", "帝出于震", "與時偕行", "盈虛", "盈" & VBA.ChrW(-31142), "盈" & VBA.ChrW(-10119) & VBA.ChrW(-8991), "盈" & VBA.ChrW(-31145), "履霜", "艮其限", "乃孚", "浚恒", "浚恆", "包蒙", "童蒙", "蒙吉", "包" & VBA.ChrW(-10132) & VBA.ChrW(-8313), "童" & VBA.ChrW(-10132) & VBA.ChrW(-8313), VBA.ChrW(-10132) & VBA.ChrW(-8313) & "吉", _
        "天在山中", "多識前言往行", "蹇蹇", "匪躬", "匪" & VBA.ChrW(-29005), "洗心", "龍德", "慎言語", VBA.ChrW(24892) & "言語", "節飲食", "改命吉", VBA.ChrW(25914) & "命吉", "開國承家", _
        "賁於丘園", "賁于丘園", "賁於邱園", "賁于邱園", "賁於" & VBA.ChrW(-10176) & VBA.ChrW(-9207) & "園", "賁于" & VBA.ChrW(-10176) & VBA.ChrW(-9207) & "園", "先天後天", "風行水上", "喪貝", VBA.ChrW(17966) & "貝", VBA.ChrW(-10124) & VBA.ChrW(-8660) & "貝", VBA.ChrW(-10173) & VBA.ChrW(-8748) & "貝", VBA.ChrW(20007) & "貝", VBA.ChrW(-10173) & VBA.ChrW(-8650) & "貝", "羝羊", "羝" & VBA.ChrW(-32119), "觸藩", "觸籓", "立其誠", "立誠", "修辭立誠", "脩辭立誠", _
        ...
        "束帛", "戔戔", "損下以益上", "損下益上", "損下而益上", "貳用缶", "納約自牖", "利見大人", "何思何慮", "同歸而殊塗", "一致而百慮", "同歸殊塗", "一致百慮", "精氣為物", "者其辭", "事不密", "事不" & VBA.ChrW(23483), _
...
'    If preceded_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("尤", "容", "未", "不", "極", "甚", "貿", "交", "物", "變", "或可", "鄙", "博", "辟", "平", "慢", "俗", "坦", "難", "脫", "流", "樂", "革", "更", "簡", "白居", "居", "淺", "輕", "險", "相", "難行", "世", "易", "所", _
            "移", "狂", "平仄相", "遂", "每歲一", "錢", "涿", "光庭、賈", "光庭賈", "為人和", "辟", "驕", "一氣一", "資和", _
            "新陳相", "捷最", "崔伯", "劉", "覆墜之", "知其難", "有不善未嘗不知", "事難慮", "事久則慮", "勢固", "立門戶也", "立門" & VBA.ChrW(25143) & "也", _
            "聽之者", "壞真從", "尋又", "壞" & VBA.ChrW(30494) & "從", "厚和", "誠不為", "可", "人欲", "市", "輒", VBA.ChrW(-28903), "遽", "過於和", "平心", "大樂必", _
            "知其至", "立節行、", "立節行", "圖難於其", "成誦", "月日時無", "使聽者之", "鮮不忽")
        dict.Add "乾", Array("白", "豆", "衣", "面自", "擰", "餅", "未", "晾", "肉", "蘿蔔", "葡萄", "龍眼", "口", "枯", "烘", "晒", "曬", "筍", "外強中")
        dict.Add "乾坤", Array("搆盡", "于此盜", "五季")
        dict.Add "豫", Array("防患於", "暇", "厎", "音", "底", "悅", "不", "弗", "劉", "猶", "逸", VBA.ChrW(-10143) & VBA.ChrW(-8996), "道", "南")
        ...
        dict.Add VBA.ChrW(-26587), Array("周敦", "程", "朵", "濬", "期", "面豐", "頂至", "泗交", "張", "楚", _
                        "獨支", "筆支", "手支", _
                        "寄藥與")
        dict.Add "巽", Array("李", "翟公", "傅", "家之", "叔", "劉", "朱")
        dict.Add VBA.ChrW(14514), Array("李", "翟公", "傅", "家之", "叔", "劉", "朱")
        dict.Add "兌", Array("李")
        dict.Add VBA.ChrW(20817), Array("李")
        dict.Add VBA.ChrW(20810), Array("李")
        dict.Add "大過", Array("可過")
        dict.Add "賁", Array("虎", "孟", "孫", "諸葛", "齎」作「", "齎作")
        ...
        dict.Add "蠱", Array("巫", "韓", "置", "蟲", "可以解", "蛇", "年之", "下", "之立", "謂水", "每遇", "土", "妖")
...
'    If followed_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("簀", "牙", "之以書契", "安居士", "幟", "轍", "厭", "水", "州", "順鼎", "破", "開罐", "筋", "姓", "名之日", "卜生", "堂", "科", _
            "守", "棺", "看", "積", "容", "衣", "萌", "葬", "獄", "其處", "名者", "曉", "得消散", "慢", "熔", "忘", "物", "易", "俗", "差", "陷", "肆", "下手", "渡", "紙易之", "腐敗", _
             "手", "如反", "善作詩", "學而", "著火", "於噴", "元善", "其田疇", "以走險", "不能堪", "直不足言", "以動人", "得鹵", "十姓", "易其形者為", "言則難", "視之", _
            "搖而難", "動難安", "昏而難", "字希", "見者", "於混亂", "以挺", "於近者。非知言者也", "於近者非知言者也", "出議論", "退之節", "玄光", "梓宮", "知由單", "占偶書", _
            "如翻", "如拾", "子而", "肩輿", "事爾", "但不香", "知而不知", "舊榜", "得汩沒", "子所作", "易生粉", "發酸", "如燎毛", "置其次")
        dict.Add "周易", Array("癡")
        ...
        dict.Add "萃", Array("於此", "此書", "于一", "古人", "之成", "其家", "江", "諸庫", "為一書", "於一門", "屼", "東壁", "育", "瀛洲之")
        ...
        dict.Add "大有", Array("功", "力", "父風", "警省", "逕庭", "李僧", "所瀦", "事在")
        dict.Add "無妄", Array("想")
...
'    If inPhrase_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("李易安", "居易錄", "蘇易簡", "杜易簡", "張易之", "此易事", "人易老", "人易去", "兩易其任", _
            "江山易主", "深耕易耨", "周易癡", "豈易得", "豈易逢", "君子易事", "竇易直", "後易為", "此易彼", "不以易其", "得而易失", "人而易私", "人而易" & VBA.ChrW(-10155) & VBA.ChrW(-8352), "以易此", "無以易也", "延易府", "皮易布", "金易一", "名易知", "雖易得", "誠至易", "則易束", "者易窺", "置易制", "難、易相", "事易行", "今易以冠服", "俱易以", "易知也", "市易法", "可以易一飽", "賈易不", "和易之氣", _
            "而易見", "而易起", "簡而易行", "而易晦", "請易之", "多易之", "公易其介", "不能易也", "最易得", "亢易招", "以易鹽米", "頓易故", "谿易雨", "者易訓", "心易偏", "平心易氣", "故其說易差", "始易為力", "乃易合", "而易彼", "慢而易之", "而易治", "樂易之", "視而易之", _
            "以易心", "以易處之", "因易其韻", "以縉儒者易之", "因改易本文而", "尺寸易以", "則易發", "根易發", "客易位", "主易位", "必易疑", "易信必易疑", _
            "而易陵", "儉則易足", "曾易占", "深德易占", "後易占", "將易吾", "者易犯", "狹則易足", "悔易勿輕踵", "智易窮", "何以易窮", "更有易見者", "而易散", _
            "至易事", "敢易也", "河東、易定", "易定、魏博", "豈易堪此", "河東易定", "脆易折", "易定魏博", "柔易治", "最易生", _
            "疾易作", "病易除", "人易從", "何以易生", "易放而難操", "氣易乘", "錢差易 ", "言易墜", "所以易放", "者易直", "是易言也", "須易之", "之易以仰測", "蓴絲之易", "皆易黃屋", "皆易" & ChrW(-24892) & "屋", "時易以新", _
            "則易使", "謀易太子", "侮易承業", "成易具", "綿布易之", "布相易云", "浴易服", "惡易敗", "一易根", "荄於易地", _
            "因易名曰", "以字易名", "籠易制", "不易長", "和易近人", "以日易月", "大樂必易", "以之易業", "以之易用", "不欲易也", "基而易舊", _
            "則易入於", "皆易與之", "死易不義", "原易范", "鐵易土", "兵易進", "亦易退", "實而易虛", "江易舟", _
            "非易事", "蠹者易之", VBA.ChrW(-30681) & "者易之", "首卷易之", "而易為待補", "晚年易名", "木易朽", _
            "豈易說", "人人易知", "人易知焉")
        ...
        dict.Add "豫", Array("事豫則", "人豫知", "而豫求", "能豫逆", "豫射其", "於豫圖", "豫州。豫。舒也")
        dict.Add "蹇", Array("剛蹇絕", "歲蹇剝", "辭以蹇字")
        ...
        dict.Add "同人", Array("底同人不", "不同人生", "不同人能", "皆指同人，未知")
