...
Property Get 易學Keywords_ToMark() As Variant 'string()因為 Array Returns a Variant containing an array,所以不能寫成 as string()
    易學Keywords_ToMark = Array("易", "周易", "易經", "大易", "五經", "六經", "七經", "十三經", "蓍", _
        ...
        "初九", "九二", "九三", "九四", "九五", "上九", VBA.ChrW(19972) & "九", "用九", "初六", "六二", "六三", "六四", "六五", "上六", "用六", "河圖", "洛書", "太極", "無極", "兩儀", _
            ...
            "咎", "咸恒", "咸恆", "大衍", "象也者", VBA.ChrW(-10145) & VBA.ChrW(-9156) & "也者", "咸之九五", "禴祭", "東鄰", "東" & VBA.ChrW(-26973), "禴" & VBA.ChrW(-10155) & VBA.ChrW(-8630), "禴" & VBA.ChrW(-10131) & VBA.ChrW(-8268), "善不積", "天下雷行", "號咷", "見龍在田", "菑畬", VBA.ChrW(-31656) & "畬", _
        ...
        "天在山中", "多識前言往行", "蹇蹇", "匪躬", "匪" & VBA.ChrW(-29005), "噬膚", "山澤通氣", "其腓", "洗心", "龍德", "慎言語", VBA.ChrW(24892) & "言語", "節飲食", "改命吉", VBA.ChrW(25914) & "命吉", "開國承家", "舊井", VBA.ChrW(26087) & "井", VBA.ChrW(-10149) & VBA.ChrW(-8300) & "井", "井谷", _
...
Property Get 易學KeywordsToMark_Exam_Followed_Avoid() As Scripting.Dictionary
    If followed_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("簀", "牙", "之以書契", "安居士", "幟", "轍", "厭", "水", "州", "順鼎", "破", "開罐", "筋", "姓", "名之日", "卜生", "堂", "科", _
            ...
            "搖而難", "動難安", "昏而難", "字希", "見者", "於混亂", VBA.ChrW(24422) & "章", "彥章", "以挺", "於近者。非知言者也", "於近者非知言者也", "出議論", "退之節", "玄光", "梓宮", "知由單", "占偶書", "世而後", "於怠惰", _
        ...
        dict.Add "萃", Array("於此", "此書", "于一", "古人", "之成", "其家", "江", "諸庫", "為一書", "於一門", "屼", "東壁", "育", "瀛洲之", "百王致治")
        dict.Add "艮", Array("岳", "嶽", "齋")
        dict.Add "賁", Array("赫", "隅之", "軍之將", "讀為僨")
...
Property Get 易學KeywordsToMark_Exam_InPhrase_Avoid() As Scripting.Dictionary
    If inPhrase_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("李易安", "居易錄", "蘇易簡", "杜易簡", "張易之", "此易事", "人易老", "人易去", "兩易其任", "最易淆", "以賢易不肖", "以治易亂", _
            ...
            "則易使", "謀易太子", "侮易承業", "成易具", "綿布易之", "勃然易動", "布相易云", "浴易服", "惡易敗", "一易根", "荄於易地", "三易其音", _
            ...
            "非易事", "蠹者易之", VBA.ChrW(-30681) & "者易之", "首卷易之", "而易為待補", "以易種姓", "晚年易名", "木易朽", "歲月易得", VBA.ChrW(27507) & "月易得", _
