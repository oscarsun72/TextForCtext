...
Property Get 易學KeywordsToMark_Exam_Preceded_Avoid() As Scripting.Dictionary
    If preceded_Avoid Is Nothing Then
        ...
        dict.Add "巽", Array("李", "翟公", "傅", "家之", "叔", "劉", "朱", "陳問", "柔", "為順為", "范")
        dict.Add VBA.ChrW(14514), Array("李", "翟公", "傅", "家之", "叔", "劉", "朱", "陳問", "為順為", "范")
        ...
        dict.Add "咎", Array("欲", "得", "歸", "不", "過", "追", "休", "厥", "自", "引", "殃", "何", "晁無", "晁丈無", "足", "受其", "重其", "任其", "論者皆", _
            "專", "示", "將有", "怨", "屈宜", "適逢其", "乖忤之", "庸得免", "微我有", "罹于", "汝用") ', "知休", "卜休", "知人休", "能知休", "身之休"
...
Property Get 易學KeywordsToMark_Exam_Followed_Avoid() As Scripting.Dictionary
    If followed_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("簀", "牙", "之以書契", "安居士", "幟", "轍", "退", "厭", "水", "州", "順鼎", "破", "開罐", "筋", "姓", "名之日", "卜生", "堂", "科", _
            "守", "棺", "看", "積", "容", "衣", "折", "萌", "葬", "獄", "敗", "壞", VBA.ChrW(22730), "其處", "汙", "污", "名者", "曉", "得消散", "慢", "熔", "忘", "物", "易", "俗", "差", "陷", "肆", "下手", "渡", "紙易之", "腐敗", _
            ...
            "失於" & VBA.ChrW(30094), "為物誘", "搖而難", "動難安", "昏而難", "一民之", "君之位", "以惑", "其好色", "字希", "直慈良", "天常", "見者", "代而改", "於混亂", VBA.ChrW(24422) & "章", "彥章", "以利動", "以挺", "於近者。非知言者也", "於近者非知言者也", "出議論", "退之節", "玄光", "梓宮", "知由單", "占偶書", "世而後", "於怠惰", _
            "如翻", "常處", "如拾", "偏於", "得做", "而難", "及哉", "以肆", "天下謂", "天下，謂", "偏于", "失則", "子而", "流於委", "肩輿", "以生怨", "以汗澤", "為求福", "為肉黍", "則學者將", "位之說", "為黍肉", "以及難", "其惡", "事爾", "但不香", "於移奪者", "知而不知", "舊榜", "得汩沒", "子所作", "易生粉", "發酸", "如燎毛", "置其次", "至沮喪", "驚也", "其為君之", "以不和", "以有比", "其為臣之")
        
        dict.Add "周易", Array("癡")
        dict.Add "卦", Array("陣", "橋", "建築")
        dict.Add "筮", Array("仕")
        dict.Add "乾", Array("淨", "隆", "谿", "寧", "祐", "餱", "土", "屎", _
        ...
        dict.Add "剝", Array("落", "削", "民", "蝕", "泐", "啄", "棗", "珠", "苔", "其皮", "去腸", "人面", "婦人衣", "而取之", "春" & VBA.ChrW(-31631), "春蔥", "芋", "了一重", "一重皮")
        dict.Add VBA.ChrW(21093), Array("落", "削", "民", "蝕", "泐", "啄", "棗", "珠", "苔", "其皮", "去腸", "人面", "婦人衣", "而取之", "春" & VBA.ChrW(-31631), "春蔥", "芋", "了一重", "一重皮")
        ...
        dict.Add "大有", Array("功", "力", "病", "父風", "警省", "逕庭", "李僧", "所瀦", "事在", "大積", "稽驗", "以畏服", "工夫")
        dict.Add "無妄", Array("想")
...
Property Get 易學KeywordsToMark_Exam_InPhrase_Avoid() As Scripting.Dictionary
    If inPhrase_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("李易安", "居易錄", "蘇易簡", "杜易簡", "張易之", "此易事", "人易老", "人易去", "兩易其任", "最易淆", "以賢易不肖", "以治易亂", _
            ...
            "而易見", "乃為易見", "而易起", "簡而易行", "而易晦", "以羊易之", "請易之", "羊易牛", "足以易之", "多易之", "公易其介", "不能易也", "最易得", "其情易見", "亢易招", "以易鹽米", "頓易故", "谿易雨", "者易訓", "心易偏", "平心易氣", "故其說易差", "始易為力", "乃易合", "而易彼", "慢而易之", "而易治", "樂易之", "視而易之", "邪正易位", "最易牽引", _
            ...
            "至易事", "以道易之", "和易以思", "較易做", "而易行", "得到易處", "曉然易見", "乃易見也", "亦易記", "功易事", "喪易而文", "言易色", "言之易耶", "易位易君", "得而易者", "有易畏", "而易知", "改柯易葉", "敢易也", "河東、易定", "易定、魏博", "豈易堪此", "以為易知", "河東易定", "脆易折", "彰癉易位", "易定魏博", "柔易治", "最易生", _
            "疾易作", "而易動", "粟易之", "病易除", "互易注文", "長易見", "其易寧戚", "然易判", "陋易見", "其易，寧", "而易昏", "敬易之", "而易奪", "無難，是以易也", "人易從", "何以易生", "易放而難操", "氣易乘", "直易行", "其易趣", "物亦易給", "錢差易 ", "言易墜", "所以易放", "者易直", "是易言也", "須易之", "之易以仰測", "蓴絲之易", "皆易黃屋", "皆易" & ChrW(-24892) & "屋", "時易以新", _
            ...
            "豈易說", "人人易知", VBA.ChrW(-29176) & "易陵躐", "親切易見", "中庸者世之所謂易", "中庸者，世之所謂易", "長大則易語", "以為易，故以為", "以為易故以為", "者易親", "者易" & VBA.ChrW(30094), "何言之易也", "人易知焉", "華飾者易于近名", "則易以興起", "而其易明" & VBA.ChrW(-10175) & VBA.ChrW(-8614), "風中則易過")
