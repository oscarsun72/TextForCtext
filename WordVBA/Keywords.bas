...
Property Get 易學Keywords_ToMark() As Variant 'string()因為 Array Returns a Variant containing an array,所以不能寫成 as string()
    易學Keywords_ToMark = Array("易", "周易", "易經", "大易", "五經", "六經", "七經", "十三經", "蓍", _
        ...
        "賁於丘園", "賁于丘園", "賁於邱園", "賁于邱園", "賁於" & VBA.ChrW(-10176) & VBA.ChrW(-9207) & "園", "賁于" & VBA.ChrW(-10176) & VBA.ChrW(-9207) & "園", "先天後天", "風行水上", _
        ...
        "束帛", "戔戔", "損下以益上", "損下益上", "損下而益上", "貳用缶", "納約自牖", "利見大人", "何思何慮", "同歸而殊塗", "一致而百慮", "同歸殊塗", "一致百慮", "精氣為物", "者其辭", _
