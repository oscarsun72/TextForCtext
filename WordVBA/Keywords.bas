...
Property Get 易學KeywordsToMark() As Variant 'string()因為 Array Returns a Variant containing an array,所以不能寫成 as string()
    易學KeywordsToMark = Array("易", "周易", "易經", "大易", "五經", "六經", "七經", "十三經", "蓍", _
        ...
        "無咎", VBA.ChrW(26080) & "咎", "天咎", "允升", "屯其膏", "豐亨", "終難", _
        "隨時之義", "庖有魚", "包有魚", "精義入神", "豶豕", "童牛", "承之羞", "雷在天上", "錫馬", "蕃庶", "晝日", "三接", "懲忿", "窒欲", "懲窒", "敬以直內", "義以方外", "迷後得主", "利西南", "品物咸章", "天下大行", "益動而", "日進無疆", "日進" & VBA.ChrW(26080) & "疆", "頻巽", "頻" & VBA.ChrW(14514), "豚魚", "頻復", "閑邪", "存誠", "乾乾", "悔吝", "憧憧", "類萬物", VBA.ChrW(-10139) & VBA.ChrW(-8938) & "萬物", VBA.ChrW(-10139) & VBA.ChrW(-8937) & "萬物", "柔順利貞", VBA.ChrW(-10163) & VBA.ChrW(-9167) & "順利貞", "比之匪人", "履貞", "貞厲", "履道坦坦", "貞吉", "直方", "木上有水", "勞民勸相", "索而得", _
        ...
        "賁於丘園", "賁于丘園", "賁於邱園", "賁于邱園", "賁於" & VBA.ChrW(-10176) & VBA.ChrW(-9207) & "園", "賁于" & VBA.ChrW(-10176) & VBA.ChrW(-9207) & "園", _
        "賁於" & VBA.ChrW(-10176) & VBA.ChrW(-9204) & "園", "賁于" & VBA.ChrW(-10176) & VBA.ChrW(-9204) & "園", "賁於" & VBA.ChrW(-10143) & VBA.ChrW(-8559) & "園", "賁于" & VBA.ChrW(-10143) & VBA.ChrW(-8559) & "園", _
        "束帛戔戔", "損下以益上", "損下益上", "損下而益上", "貳用缶", "納約自牖", "利見大人", "精氣為物", _
        "游魂為變", "遊" & VBA.ChrW(19487) & "為變", "游" & VBA.ChrW(19487) & "為變", _
...
Property Get 易學KeywordsToMark_ExamPrecededAvoid() As Scripting.Dictionary
    ...
    dict.Add "易", Array("尤", "容", "未", "不", "極", "甚", "貿", "交", "物", "變", "或可", "鄙", "博", "辟", "平", "慢", "俗", "坦", "難", "脫", "流", "樂", "革", "更", "簡", "白居", "居", "淺", "輕", "險", "相", "難行", "世", "易", "所", _
        "移", "狂", "平仄相", "遂", "每歲一", "錢", "光庭、賈", "光庭賈", "為人和", "辟", "驕", "一氣一", "資和", _
...
Property Get 易學KeywordsToMark_ExamFollowedAvoid() As Scripting.Dictionary
    ...
    dict.Add "易", Array("簀", "牙", "之以書契", "安居士", "幟", "轍", "厭", "水", "州", "順鼎", "破", "開罐", "筋", "姓", "名之日", "卜生", "堂", "科", _
        ...
        "搖而難", "昏而難", "字希", "見者", "於混亂", "以挺", "於近者。非知言者也", "於近者非知言者也", "出議論", "退之節", "玄光", "梓宮", "知由單", "占偶書", _
    ...
    dict.Add "萃", Array("於此", "此書", "于一", "古人", "之成", "其家", "江", "諸庫", "為一書", "於一門", "屼", "東壁", "育")
...
Property Get 易學KeywordsToMark_ExamInPhraseAvoid() As Scripting.Dictionary
    ...
    dict.Add "易", Array("李易安", "居易錄", "蘇易簡", "杜易簡", "張易之", "此易事", "人易老", "人易去", "兩易其任", _
        ...
        "因易名曰", "以字易名", "籠易制", "不易長", "和易近人", "大樂必易", "以之易業", "以之易用", "不欲易也", "基而易舊", _
        "則易入於", "皆易與之", "死易不義", "鐵易土", "兵易進", "亦易退", "實而易虛", "江易舟", _
        "非易事", "首卷易之", "而易為待補", _
        "豈易說")
