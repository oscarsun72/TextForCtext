...
Property Get 易學KeywordsToMark_ExamPrecededAvoid() As Scripting.Dictionary
    ...
    dict.Add "中孚", Array("周")
    dict.Add "渙", Array("崔")
    dict.Add VBA.ChrW(28067), Array("崔")
    dict.Add "蠱", Array("韓", "置")
    dict.Add "九二", Array("卷四", "卷")
    dict.Add "六四", Array("卷")
    dict.Add "咎", Array("追", "自", "引", "何", "專")
    dict.Add "貞吉", Array("曹")
    dict.Add "易簡", Array("蘇")
...
Property Get 易學KeywordsToMark_ExamFollowedAvoid() As Scripting.Dictionary
    ...
    dict.Add "蹇", Array("諤")
    dict.Add "渙", Array("然", "散")
    dict.Add VBA.ChrW(28067), Array("然", "散")
    dict.Add "頤", Array("和園", "正叔", "字正", "茂叔", "字茂")
    dict.Add "萃", Array("此書")
    dict.Add "巽", Array("懦")
    dict.Add "蠱", Array("自埋", "之詐", "實生子")
