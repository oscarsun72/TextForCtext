...
Property Get 易學Keywords_ToMark() As Variant 'string()因為 Array Returns a Variant containing an array,所以不能寫成 as string()
    易學Keywords_ToMark = Array("易", "周易", "易經", "大易", "五經", "六經", "七經", "十三經", "蓍", _
        ...
        "無悶", VBA.ChrW(26080) & "悶", "悔亡", "悔" & VBA.ChrW(20158), "悔" & VBA.ChrW(20838), "時義", "健順", "內健而外順", "內健外順", "外順而內健", "外順內健", "易簡", "易" & VBA.ChrW(-10153) & VBA.ChrW(-9007), "敦復", "開物成務", "窮神知化", "研幾極深", "極深研幾", "見善則遷", "有過則改", "遷善改過", "夕惕", "惕若", "一" & VBA.ChrW(-27006) & "一陽", "一陰一陽", "我有好爵", "言有序", "有聖人之道四", "長子帥師", "弟子輿尸", "日用而不知", "日用不知", "之道鮮", "原始反終", "然不動", "感而遂通", "朋從", "朋盍", "容民畜眾", "容民畜" & VBA.ChrW(-30650), "養正", "養賢", "知臨", "臨大君", "默而成之", VBA.ChrW(-24871) & "而成之", "不言而信", "存乎德行", "通天下之志", "履正", "繼之者善", "仁者見之", "知者見之", "智者見之", "撝謙", VBA.ChrW(-10114) & VBA.ChrW(-9019) & "謙", "理財", "正辭", "禁民為非", _
...
Property Get 易學KeywordsToMark_Exam_Followed_Avoid() As Scripting.Dictionary
    If followed_Avoid Is Nothing Then
        ...
        dict.Add "大有", Array("功", "力", "父風", "警省", "逕庭", "李僧", "所瀦", "事在", "大積")
        dict.Add "無妄", Array("想")
...
Property Get 易學KeywordsToMark_Exam_InPhrase_Avoid() As Scripting.Dictionary
    If inPhrase_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("李易安", "居易錄", "蘇易簡", "杜易簡", "張易之", "此易事", "人易老", "人易去", "兩易其任", "最易淆", "以賢易不肖", "以治易亂", _
            ...
            "思以易天下", "則易使", "不能易君子", "謀易太子", "侮易承業", "成易具", "綿布易之", "勃然易動", "布相易云", "浴易服", "惡易敗", "一易根", "荄於易地", "三易其音", _
