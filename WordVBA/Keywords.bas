...
Property Get 易學Keywords_ToMark() As Variant 'string()因為 Array Returns a Variant containing an array,所以不能寫成 as string()
    易學Keywords_ToMark = Array("易", "周易", "易經", "大易", "五經", "六經", "七經", "十三經", "蓍", _
        ...
        "天在山中", "立人之道", "多識前言" & VBA.ChrW(24451) & "行", "多識前言往行", "蹇蹇", "匪躬", "匪" & VBA.ChrW(-29005), "噬膚", "山澤通氣", "其腓", "洗心", "龍德", "慎言語", VBA.ChrW(24892) & "言語", "節飲食", "改命吉", VBA.ChrW(25914) & "命吉", "開國承家", "舊井", VBA.ChrW(26087) & "井", VBA.ChrW(-10149) & VBA.ChrW(-8300) & "井", "井谷", _
        ...
        "確乎", "碻乎", "束帛", "戔戔", "損下以益上", "損下益上", "損下而益上", "貳用缶", "納約自牖", "利見大人", "何思何慮", "同歸而殊塗", "一致而百慮", "同歸殊塗", "一致百慮", "精氣為物", "者其辭", "事不密", "事不" & VBA.ChrW(23483), "喪貝", VBA.ChrW(-10173) & VBA.ChrW(-8748) & "貝", "日新", _
        "游魂為變", "遊" & VBA.ChrW(19487) & "為變", "游" & VBA.ChrW(19487) & "為變", "漣如", "威如", "焚如", "朋亡", "渙其群", VBA.ChrW(28067) & "其群", "渙其" & VBA.ChrW(32675), VBA.ChrW(28067) & "其" & VBA.ChrW(32675), "甲三日", "庚三日", "升其高陵", "升其" & VBA.ChrW(-25895) & "陵", "天道虧盈", "祗悔", "祇悔", "秖悔", "秪悔", _
        "寬以居之", VBA.ChrW(23515) & "以居之", VBA.ChrW(23485) & "以居之", VBA.ChrW(-10170) & VBA.ChrW(-8618) & "以居之", _
...
Property Get 易學KeywordsToMark_Exam_Preceded_Avoid() As Scripting.Dictionary
    If preceded_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("尤", "容", "未", "不", "極", "甚", "貿", "交", "物", "變", "或可", "鄙", "博", "辟", "平", "慢", "竄", "俗", "坦", "難", "脫", "流", "樂", "革", "更", "簡", "白居", "居", "淺", "輕", "險", "相", "難行", "世", "易", "所", _
            "移", "狂", "平仄相", "遂", "每歲一", "錢", "涿", "朔", "葉", "卻", "躁", VBA.ChrW(21364), VBA.ChrW(-10143) & VBA.ChrW(-8533), "傳寫之便", "光庭、賈", "光庭賈", "為人和", "辟", "驕", "一氣一", "資和", "贖愆", _
            "丘不與", "不足以", "以粟", "起而不與", "新陳相", "所當改", "躐", "捷最", "上下互", "難而", "無諂", "肯改", "崔伯", "劉", "奢", "覆墜之", "不能", "知其難", "得失之", "卻省", VBA.ChrW(21364) & "省", "有不善未嘗不知", "事難慮", "事久則慮", "勢固", "立門戶也", "立門" & VBA.ChrW(25143) & "也", "葛之之", "飲之之", _
            "聽之者", "壞真從", "喪失之", "為惡則", "言兮毋", "家弗能", "時既", "則忘之", "成材也", "不察則", "可得而", "尋又", "愉和", "壞" & VBA.ChrW(30494) & "從", "厚和", "誠不為", "可", "人欲", "市", "輒", VBA.ChrW(-28903), "遽", "過於和", "平心", "大樂必", _
            "切磋之功", VBA.ChrW(-10175) & VBA.ChrW(-8614) & "富", "暑反", "處富", "忽其", "於我之", "弗抑則", "君便道", "知其至", "反復於其", "立節行、", "非難非", "求信則", "無身過", "順而", "不敢以", "其來之", "非心", "至之亦", "無口過", "甚順且", "心便", "其正外", "盜固", "立節行", "圖難於其", "成誦", "月日時無", "使聽者之", "嶽號五", "鮮不忽", "而外和", "致終身之", "以天下與人", "詰王與", "未達之所守", "實理自然故", "之久而續之")
            
        dict.Add "乾", Array("白", "涸", "豆", "衣", "面自", "暴", "擰", "餅", "未", "晾", "肉", "蘿蔔", "葡萄", "龍眼", "口", "枯", "烘", "晒", "曬", "筍", "外強中", "暴之")
        dict.Add "乾坤", Array("搆盡", "于此盜", "五季")
        dict.Add "豫", Array("防患於", "暇", "厎", "音", "底", "悅", "不", "弗", "劉", "猶", "逸", VBA.ChrW(-10143) & VBA.ChrW(-8996), "道", "南", "美熙", "戲", VBA.ChrW(25135), "天心")
        
        dict.Add "剝", Array("刻", "活", "可", "剽", "褫", "皴", "為之解", "歲蹇", "石斷")
        dict.Add VBA.ChrW(21093), Array("刻", "活", "可", "剽", "褫", "為之解", "歲蹇", "石斷")
        
        dict.Add "頤", Array("周敦", "周惇", "程", "朵", "濬", "期", "面豐", "頂至", "泗交", "張", "楚", _
                        "獨支", "筆支", "手支", "又奏", _
                        "寄藥與")
        dict.Add VBA.ChrW(-26587), Array("周敦", "周惇", "程", "朵", "濬", "期", "面豐", "頂至", "泗交", "張", "楚", _
                        "獨支", "筆支", "手支", "又奏", _
                        "寄藥與")
                        
        dict.Add "巽", Array("李", "翟公", "傅", "家之", "叔", "劉", "朱", "陳問", "柔", "為順為", "范", "洪")
        dict.Add VBA.ChrW(14514), Array("李", "翟公", "傅", "家之", "叔", "劉", "朱", "陳問", "為順為", "范", "洪")
        
        dict.Add "兌", Array("李")
        dict.Add VBA.ChrW(20817), Array("李")
        dict.Add VBA.ChrW(20810), Array("李")
        
        dict.Add "大過", Array("可過", "公頗無", "君有", "天下", "天下之", "稱許", "許皆", "自許")
        ...
        dict.Add "暌", Array("以分")
        dict.Add "遯", Array("毅然知肥", "子宜速", "隱", VBA.ChrW(-10141) & VBA.ChrW(-8442))
        ...
        dict.Add "文言", Array("與上", "且上", "承上")
        dict.Add "筮", Array("初", "再")
        dict.Add "咎", Array("欲", "得", "歸", "不", "過", "追", "休", "厥", "自", "引", "殃", "何", "晁無", "晁丈無", "足", "受其", "重其", "任其", "論者皆", _
            "專", "示", "舅為", "將有", "怨", "屈宜", "適逢其", "乖忤之", "庸得免", "微我有", "罹于", "汝用") ', "知休", "卜休", "知人休", "能知休", "身之休"
        
        dict.Add "無妄", Array("真實", "誠而", "至善", "實有而", "忠者", "極誠")
        dict.Add VBA.ChrW(26080) & "妄", Array("真實", "誠而", "至善", "實有而")
        dict.Add VBA.ChrW(26080) & VBA.ChrW(-10171) & VBA.ChrW(-8522), Array("真實", "誠而", "至善", "實有而")
        
        dict.Add "元亨", Array("董", "萬")
        dict.Add "貞吉", Array("曹")
        dict.Add "悔吝", Array("平生")
        dict.Add "無咎", Array("晁", "晁丈", "國將")
        dict.Add "直方", Array("張", "王", "字", "枉者")
...
Property Get 易學KeywordsToMark_Exam_Followed_Avoid() As Scripting.Dictionary
    If followed_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("簀", "牙", "之以書契", "安居士", "幟", "轍", "退", "厭", "水", "州", "順鼎", "破", "開罐", "筋", "姓", "名之日", "卜生", "堂", "科", _
            "守", "棺", "看", "犯", "積", "容", "衣", "折", "萌", "葬", "獄", "敗", "壞", VBA.ChrW(22730), "其處", "汙", "污", "名者", "曉", "得消散", "慢", "熔", "忘", "物", "易", "俗", "差", "陷", "肆", "下手", "渡", "紙易之", "腐敗", _
            "爛", "手", "粟", "直也", "如反", "地則", "製", "事者", "地皆", "其言者", "進而", "其言而", "善作詩", "治也", "制伏", "樂者必多哀", "以成誦", "位之事", "直子諒", "察者", "學而", "著火", "於噴", "元善", "之以羊", "其田疇", "世之後", "以走險", "其氣", "不能堪", "直不足言", "以動人", "得鹵", "十姓", "易其形者為", "言則難", "視之", _
            "失於" & VBA.ChrW(30094), "為物誘", "搖而難", "動難安", "昏而難", "禽於籠", "一民之", "君之位", "以惑", "其好色", "字希", "直慈良", "天常", "見者", "代而改", "於混亂", VBA.ChrW(24422) & "章", "彥章", "以利動", "以挺", "於近者。非知言者也", "於近者非知言者也", "出議論", "退之節", "玄光", "梓宮", "知由單", "占偶書", "世而後", "於怠惰", _
            "如翻", "常處", "如拾", "發疾", VBA.ChrW(-10157) & VBA.ChrW(-8395) & "疾", "偏於", "得做", "而難", "及哉", "以肆", "天下謂", "天下，謂", "偏于", "失則", "子而", "流於委", "肩輿", "以生怨", "以汗澤", "為求福", "為肉黍", "則學者將", "位之說", "為黍肉", "以及難", "其惡", "事爾", "但不香", "於移奪者", "知而不知", "舊榜", "得汩沒", "子所作", "易生粉", "發酸", "如燎毛", "置其次", "至沮喪", "驚也", "其為君之", "以不和", "以有比", "其為臣之")
        
        dict.Add "周易", Array("癡")
        dict.Add "卦", Array("陣", "橋", "建築")
        dict.Add "筮", Array("仕")
        dict.Add "乾", Array("淨", "隆", "谿", "寧", "祐", "餱", "土", "屎", "紫黑", _
            "道初", "道元年", "道二年", "道三年", "道四年", "道五年", "道七月", _
            "和中", "枯", "坤清泰", "坤之清氣", "鵲", "闕一" & VBA.ChrW(-28146) & "金")
        dict.Add "乾坤", Array("陷吉人", "清泰", "之清氣")
        dict.Add "豫", Array("章", "讓", "王", "瞻", "兮若", "則立", "州", "暇", "知", "劇", "備", VBA.ChrW(20675), "防", "聞", "樟", "憂思", VBA.ChrW(13529) & "事", "凶事", _
            "先要", "豫為言之", "豫" & VBA.ChrW(29234) & "言之", "子", "卜地")
            
        dict.Add "剝", Array("落", "皮", "削", "民", "蝕", "泐", "啄", "棗", "珠", "苔", "其皮", "去腸", "人面", "婦人衣", "而取之", "春" & VBA.ChrW(-31631), "春蔥", "芋", "了一重", "一重皮")
        dict.Add VBA.ChrW(21093), Array("落", "皮", "削", "民", "蝕", "泐", "啄", "棗", "珠", "苔", "其皮", "去腸", "人面", "婦人衣", "而取之", "春" & VBA.ChrW(-31631), "春蔥", "芋", "了一重", "一重皮")
        
        dict.Add "蹇", Array("諤", "驢", "叔", "氏", "周", "淺", "序辰", "材望", "毅然", "已莫", "步", "吃")
        dict.Add "渙", Array("然", "散", "遂踰", "指陳是", "贓污")
        dict.Add VBA.ChrW(28067), Array("然", "散", "遂踰", "指陳是", "贓污")
        dict.Add "夬", Array("切")
        
        dict.Add "頤", Array("和園", "正叔", "字正", "茂叔", "字茂", "指氣使", "庵", "菴", "盦", "谷", "下有皮", "所以不", "道德", "之見知", "之司", "之門", "兄弟", "之學", "之行", "其後十有餘")
        dict.Add VBA.ChrW(-26587), Array("和園", "正叔", "字正", "茂叔", "字茂", "指氣使", "庵", "菴", "盦", "谷", "下有皮", "所以不", "道德", "之見知", "之司", "之門", "兄弟", "之學", "之行", "其後十有餘")
        
        dict.Add "萃", Array("於此", "此書", "于一", "古人", "之成", "其家", "江", "諸庫", "為一書", "於一門", "屼", "東壁", "育", "瀛洲之", "百王致治", "成六卷")
        dict.Add "艮", Array("岳", "嶽", "齋")
        dict.Add "賁", Array("赫", "隅之", "軍之將", "讀為僨", "字", "軍", "音奔", "豚")
        
        dict.Add "巽", Array("巖", VBA.ChrW(23891), "懦", "字仲", "亦不較", "後仕", "風疏", "博學", "參政", "前問")
        dict.Add VBA.ChrW(14514), Array("巖", "懦", "字仲", "亦不較", "後仕", "風疏", "博學", "參政", "前問")
        
        dict.Add "蠱", Array("惑人心", "蕩", "於心", "自埋", "之詐", "實生子", "毒", "發膨", "主", "之屬", "有鬼", "不絕", "者是也", "嫩", VBA.ChrW(23280), "脹", "皆中人")
        dict.Add "暌", Array("」作「睽", "作睽", "隔", "叟")
        dict.Add "坎", Array(VBA.ChrW(22728), "鼓", VBA.ChrW(30391), "坎" & VBA.ChrW(30391) & "我", "坎擊" & VBA.ChrW(30391), "擊" & VBA.ChrW(30391), "坎擊鼓", "擊鼓")
        dict.Add "遯", Array("跡", VBA.ChrW(-28679), "世", "齋", "世修真", "世不見")
        dict.Add "兌", Array("命")
        dict.Add VBA.ChrW(20817), Array("命")
        dict.Add VBA.ChrW(20810), Array("命")
        dict.Add "小畜", Array("集")
        dict.Add "同人", Array("醵錢", "道於")
        dict.Add "中孚", Array("禪子")
        dict.Add "大有", Array("功", "力", "病", "父風", "警省", "逕庭", "李僧", "所瀦", "事在", "大積", "稽驗", "以畏服", "工夫", "裨益", "逕庭")
        dict.Add "無妄", Array("想")
        dict.Add VBA.ChrW(26080) & "妄", Array("想")
        dict.Add VBA.ChrW(26080) & VBA.ChrW(-10171) & VBA.ChrW(-8522), Array("想")
        dict.Add "大過", Array("人者", "謂足以亡", "非不諫", "人之才")
        dict.Add "小過", Array("宜寬", "宜" & VBA.ChrW(23515), "非不諫")
        dict.Add "初九", Array("日")
        dict.Add "初六", Array("日")
        dict.Add "六四", Array("）")
        dict.Add "上六", Array("十里")
        dict.Add "用六", Array("味")
        dict.Add "象日", Array("月星辰", "以殺")
        dict.Add "文言", Array("惇懿")
        dict.Add "少陰", Array("雨")
        dict.Add "咎", Array("犯", "繇", "陶", "過也", "彼", "單", "累", "在人之相", VBA.ChrW(-10172) & VBA.ChrW(-8632) & "人之相", "徵之應")
        ...
        dict.Add "大衍", Array("曆")
        dict.Add "終難", Array("得定")
        dict.Add "時義", Array("所當然")
        
        dict.Add "養正", Array("丹")
        dict.Add VBA.ChrW(-26357) & "正", Array("丹")
...
Property Get 易學KeywordsToMark_Exam_InPhrase_Avoid() As Scripting.Dictionary
    If inPhrase_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("李易安", "居易錄", "蘇易簡", "杜易簡", "張易之", "此易事", "人易老", "人易去", "兩易其任", "最易淆", "以賢易不肖", "以治易亂", _
            "江山易主", "深耕易耨", "賢易色", "與其易也", "周易癡", "豈易得", "改易也", "豈易逢", "君子易事", "竇易直", "小易大", "後易為", "此易彼", "不以易其", "得而易失", "人而易私", "人而易" & VBA.ChrW(-10155) & VBA.ChrW(-8352), "以易此", "無以易也", "延易府", "皮易布", "金易一", "名易知", "雖易得", "誠至易", "則易束", "者易窺", "置易制", "難、易相", "事易行", "今易以冠服", "俱易以", "易知也", "市易法", "可以易一飽", "賈易不", "和易之氣", "氣易壅", "心易放", "躁而易遷", "淺而易洩", _
            "而易見", "乃為易見", "或易言之", "而易起", "簡而易行", "而易晦", "以羊易之", "請易之", "羊易牛", "足以易之", "多易之", "公易其介", "不能易也", "最易得", "其情易見", "亢易招", "以易鹽米", "頓易故", "谿易雨", "者易訓", "心易偏", "平心易氣", "故其說易差", "始易為力", "乃易合", "而易彼", "慢而易之", "而易治", "樂易之", "視而易之", "邪正易位", "最易牽引", _
            "言易入", "其得易失", "以易之也", "以易心", "而易操", "病易見", "實易行", "無以易之", "誰以易之", "豈易及", "以易處之", "則易從", "未之能易也", "又易入", "既易知", "先其易者", "先易後難", "則易位", "反易天明", "淺近易見", "因易其韻", "以縉儒者易之", "因改易本文而", "尺寸易以", "客易主位", "願亦易愜", "則易發", "根易發", "客易位", "以改易之", "主易位", "必易疑", "易信必易疑", "平實易知", "簡要易行", _
            "傷易則誕", "而易陵", "皆易之以", "失易見", "事在易而求", "儉則易足", "過易辭", "惑易解", "為易入", "所有易其", "可以易位", "曾易占", "欲易足", "不能易焉", "深德易占", "後易占", "將易吾", "者易犯", "狹則易足", "悔易勿輕踵", "智易窮", "何以易窮", "更有易見者", "而易散", "道易明", "教易行", _
            "至易事", "以道易之", "和易以思", "火易動", "較易做", "遠利而易以仁義", "而易行", "味易過", "得到易處", "曉然易見", "乃易見也", "亦易記", "功易事", "喪易而文", "言易色", "言之易耶", "易位易君", "得而易者", "有易畏", "而易知", "改柯易葉", "敢易也", "河東、易定", "易定、魏博", "豈易堪此", "以為易知", "河東易定", "脆易折", "彰癉易位", "易定魏博", "柔易治", "最易生", _
            "疾易作", "而易動", "則易字", "粟易之", "病易除", "氣易動", "互易注文", "長易見", "其易寧戚", "然易判", "陋易見", "其易，寧", "而易昏", "敬易之", "而易奪", "無難，是以易也", "人易從", "何以易生", "易放而難操", "氣易乘", "直易行", "其易趣", "物亦易給", "錢差易 ", "言易墜", "所以易放", "者易直", "是易言也", "須易之", "之易以仰測", "蓴絲之易", "皆易黃屋", "皆易" & ChrW(-24892) & "屋", "時易以新", _
            "思以易天下", "職易稱", "職易" & VBA.ChrW(-10127) & VBA.ChrW(-8979), "心易衰", "美質易得", "則易使", "之易其言", "不能易君子", "事易王", "扶而易之", "終以為易而又", "運於掌言易也", "運於掌，言易也", "終以為易，而又", "謀易太子", "侮易承業", "卑近易行", "經師易獲", "成易具", "綿布易之", "勃然易動", "布相易云", "浴易服", "惡易敗", "一易根", "荄於易地", "三易其音", _
            "因易名曰", "易見易除", "以字易名", "放言易故", "亂易亂", "婿易見", "壤易處", "信易食", "信易生", "小則易足", "足則無", "合而易離", VBA.ChrW(22779) & "易見", "所賤易所貴", "敢易乎", "食而易得", "籠易制", "去之易也", "仁民易而", "差錯故易說", "差錯，故易說", "論人易矣", "故易辨也", "不易長", "惡幾易熾", "和易近人", "以日易月", "至易而行難", "大樂必易", "以之易業", "以之易用", "不欲易也", "基而易舊", _
            "心易以生", "則易入於", "皆易與之", "道易行", "王易王", "霸易霸", "死易不義", "原易范", "鐵易土", "德易勉", "兵易進", "亦易退", "實而易虛", "江易舟", "苦于易奪", "傷于易敗", "相信，易以成功", _
            "非易事", "有易於內者", "蠹者易之", VBA.ChrW(-30681) & "者易之", "多與易則", "故易以成就", "厚易直", "首卷易之", "而易為待補", "以易種姓", "晚年易名", "木易朽", "歲月易得", VBA.ChrW(27507) & "月易得", _
            "豈易說", "人人易知", VBA.ChrW(-29176) & "易陵躐", "必易於古", "親切易見", "中庸者世之所謂易", "中庸者，世之所謂易", "長大則易語", "以為易，故以為", "以為易故以為", "者易親", "者易" & VBA.ChrW(30094), "何言之易也", "人易知焉", "華飾者易于近名", "則易以興起", "而其易明" & VBA.ChrW(-10175) & VBA.ChrW(-8614), "風中則易過")
        
        dict.Add "卦", Array("八卦山", "八卦殿")
        dict.Add "爻", Array("如交爻字")
        dict.Add "乾", Array("保乾圖", "大乾廟", "乳乾者", "雨乾時", "五季乾坤", "風處乾之")
        dict.Add "剝", Array("解剝而發明", "造剝洛陽")
        dict.Add VBA.ChrW(21093), Array("解" & VBA.ChrW(21093) & "而發明", "造" & VBA.ChrW(21093) & "洛陽")
        dict.Add "豫", Array("事豫則", "康哉豫矣", "人豫知", "而豫求", "能豫逆", "豫射其", "於豫圖", "豫州。豫。舒也", "故豫戒之", "以豫為先", "而豫待")
        dict.Add "蹇", Array("剛蹇絕", "歲蹇剝", "辭以蹇字", "驕蹇之心")
        
        dict.Add "頤", Array("翁頤昌", "方頤大口", "解頤撫掌", "兩頤間", "解頤而悅", "曾與頤言")
        dict.Add VBA.ChrW(-26587), Array("翁" & VBA.ChrW(-26587) & "昌", "方" & VBA.ChrW(-26587) & "大口", "解" & VBA.ChrW(-26587) & "而悅", "曾與頤言")
        
        dict.Add "暌", Array("有暌談笑")
        dict.Add "蠱", Array("以蠱留人", "以蠱而", "而蠱者", "以蠱大", "中蠱者", "內蠱豔")
        dict.Add "萃", Array("檀萃文", "陽萃焉")
        dict.Add "賁", Array("古賁灰", "隸書賁字", "廣賁之", "苗賁皇")
        
        dict.Add "巽", Array("即巽也", "東巽泉", "邀巽二", "公巽曰", "公巽默", "容巽順")
        dict.Add VBA.ChrW(14514), Array("即" & VBA.ChrW(14514) & "也", "東" & VBA.ChrW(14514) & "泉", "公" & VBA.ChrW(14514) & "曰", "公" & VBA.ChrW(14514) & "默")
        
        dict.Add "同人", Array("底同人不", "不同人生", "不同人能", "皆指同人，未知", "要之以己同人則", "之不同人得其", "不同人字", "不同人君", "不同人雖")
        dict.Add "夬", Array("十七夬部")
        dict.Add "坎", Array("科坎也")
        
        dict.Add "渙", Array("王渙之", "令渙往", "叱渙事")
        dict.Add VBA.ChrW(28067), Array("王" & VBA.ChrW(28067) & "之", "令" & VBA.ChrW(28067) & "往", "叱" & VBA.ChrW(28067) & "事")
        
        dict.Add "大有", Array("甚大有朱", "碩大有顒", "小大有定", "有大有小", "差大有芒")
        dict.Add "大壯", Array("祖大壯之")
        dict.Add "大過", Array("無大過惡", "有大過則", "必大過而")
        dict.Add "小過", Array("忘小過以成", VBA.ChrW(14592) & "小過以成", "雖小過而", "省小過差")
        
        dict.Add "既濟", Array("河既濟真")
        dict.Add VBA.ChrW(26083) & "濟", Array("河" & VBA.ChrW(26083) & "濟真")
        
        dict.Add "無妄", Array("人無妄取", "物無妄費", "內無妄思", "外無妄動")
        dict.Add VBA.ChrW(26080) & "妄", Array("人" & VBA.ChrW(26080) & "妄取", "物" & VBA.ChrW(26080) & "妄費", "內無妄思", "外無妄動")
        dict.Add VBA.ChrW(26080) & VBA.ChrW(-10171) & VBA.ChrW(-8522), Array("人" & VBA.ChrW(26080) & VBA.ChrW(-10171) & VBA.ChrW(-8522) & "取", "物" & VBA.ChrW(26080) & VBA.ChrW(-10171) & VBA.ChrW(-8522) & "費", "內無妄思", "外無妄動")
        ...
        dict.Add "六三", Array("洪範》六三", "洪範六三", "洪範〉六三")
        dict.Add "六四", Array("一六四八")
        dict.Add "上六", Array("以上六事", "已上六事", "以上六十")
        dict.Add "用六", Array("威用六極")
        dict.Add "文言", Array("承此文言之", "古文言『毌", "古文言毌", "有文言語", "為文言器")
        dict.Add "存誠", Array("心存誠敬")
        dict.Add "童蒙", Array("民童蒙不")
        dict.Add "象云", Array("形象云云")
        dict.Add "咎", Array("其咎責", "用咎云")
        dict.Add "敬義", Array("說敬義同")
        dict.Add "中正", Array("於中正其心")
        dict.Add "威如", Array("畏威如疾")
        
        dict.Add "少陰", Array("手少陰經", "足少陰經")
