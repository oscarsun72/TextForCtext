...
Property Get 易學Keywords_ToMark() As Variant 'string()因為 Array Returns a Variant containing an array,所以不能寫成 as string()
    易學Keywords_ToMark = Array("易", "周易", "易經", "大易", "五經", "六經", "七經", "十三經", "蓍", _
        ...
        "括囊", "無悶", VBA.ChrW(26080) & "悶", "悔亡", "悔" & VBA.ChrW(20158), "悔" & VBA.ChrW(20838), "時義", "健順", "內健而外順", "內健外順", "外順而內健", "外順內健", "易簡", "易" & VBA.ChrW(-10153) & VBA.ChrW(-9007), "敦復", "開物成務", "窮神知化", "研幾極深", "極深研幾", "研幾", VBA.ChrW(30799) & "幾", "見善則遷", "有過則改", "遷善改過", "夕惕", "惕若", "一" & VBA.ChrW(-27006) & "一陽", "一陰一陽", "我有好爵", "言有序", "有聖人之道四", "長子帥師", "弟子輿尸", "日用而不知", "日用不知", "之道鮮", "原始反終", "然不動", "感而遂通", "朋從", "朋盍", "容民畜眾", "容民畜" & VBA.ChrW(-30650), "養正", "養賢", "知臨", "臨大君", "變化云", VBA.ChrW(-10164) & VBA.ChrW(-9163) & "化云", "神道設教", "神道設" & VBA.ChrW(25934), "默而成之", VBA.ChrW(-24871) & "而成之", "不言而信", "存乎德行", "通天下之志", "履正", "繼之者善", "仁者見之", "知者見之", "智者見之", "撝謙", VBA.ChrW(-10114) & VBA.ChrW(-9019) & "謙", "理財", "正辭", "禁民為非", _
        ...
        "確乎", "碻乎", "束帛", "戔戔", "輝光", "損下以益上", "損下益上", "損下而益上", "貳用缶", "納約自牖", "利見大人", "何思何慮", "同歸而殊塗", "一致而百慮", "同歸殊塗", "一致百慮", "精氣為物", "者其辭", "事不密", "事不" & VBA.ChrW(23483), "喪貝", VBA.ChrW(-10173) & VBA.ChrW(-8748) & "貝", "日新", _
...
Property Get 易學KeywordsToMark_Exam_Preceded_Avoid() As Scripting.Dictionary
    If preceded_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("尤", "容", "未", "不", "極", "甚", "貿", "交", "物", "變", "或可", "鄙", "博", "辟", "平", "慢", "竄", "俗", "坦", "難", "脫", "流", "樂", "革", "更", "簡", "白居", "居", "淺", "輕", "險", "相", "難行", "世", "易", "所", _
            ...
            "叔", "丘不與", "不足以", "以粟", "起而不與", "新陳相", "所當改", "躐", "捷最", "上下互", "難而", "無諂", "肯改", "崔伯", "劉", "奢", "覆墜之", "不能", "知其難", "得失之", "卻省", VBA.ChrW(21364) & "省", "有不善未嘗不知", "事難慮", "事久則慮", "勢固", "立門戶也", "立門" & VBA.ChrW(25143) & "也", "葛之之", "飲之之", _
            "聽之者", "壞真從", "喪失之", "辟易萬夫", "為惡則", "言兮毋", "家弗能", "時既", "則忘之", "成材也", "不察則", "可得而", "尋又", "愉和", "壞" & VBA.ChrW(30494) & "從", "厚和", "誠不為", "可", "人欲", "市", "輒", VBA.ChrW(-28903), "遽", "過於和", "平心", "大樂必", _
        ...
        dict.Add "乾", Array("白", "涸", "豆", "衣", "面自", "暴", "擰", "餅", "未", "晾", "肉", "蘿蔔", "葡萄", "龍眼", "口", "枯", "烘", "晒", "曬", "筍", "外強中", "暴之", "整頓")
        dict.Add "乾坤", Array("搆盡", "于此盜", "五季", "整頓")
        ...
        dict.Add "賁", Array("虎", "孟", "孫", "諸葛", "齎」作「", "齎作", "東海襄", "三足為")
        dict.Add "坎", Array("窠")
        ...
        dict.Add "咎", Array("欲", "得", "歸", "不", "過", "追", "休", "厥", "自", "引", "殃", "何", "晁無", "晁丈無", "足", "受其", "重其", "任其", "論者皆", _
            "專", "示", "舅為", "將有", "怨", "屈宜", "適逢其", "乖忤之", "庸得免", "微我有", "罹于", "汝用", _
            "不薦之")
            ', "知休", "卜休", "知人休", "能知休", "身之休" ,
        ...
        dict.Add "無極", Array("與天", "作配", "，永", "天命之", "垂範")
        dict.Add "易簡", Array("蘇")
...
Property Get 易學KeywordsToMark_Exam_Followed_Avoid() As Scripting.Dictionary
    If followed_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("簀", "牙", "之以書契", "安居士", "幟", "轍", "退", "厭", "水", "州", "順鼎", "破", "開罐", "筋", "姓", "名之日", "卜生", "堂", "科", _
            ...
            "如剛", "爛", "手", "粟", "直也", "如反", "地則", "製", "事者", "地皆", "其言者", "進而", "其言而", "善作詩", "治也", "制伏", "樂者必多哀", "以成誦", "位之事", "直子諒", "察者", "學而", "著火", "於噴", "元善", "之以羊", "其田疇", "世之後", "以走險", "其氣", "不能堪", "直不足言", "以動人", "得鹵", "十姓", "易其形者為", "言則難", "視之", _
            "朝服", "其門戶", "失於" & VBA.ChrW(30094), "為物誘", "搖而難", "動難安", "昏而難", "禽於籠", "一民之", "君之位", "以惑", "其好色", "字希", "直慈良", "天常", "見者", "代而改", "於混亂", VBA.ChrW(24422) & "章", "彥章", "以利動", "以挺", "於近者。非知言者也", "於近者非知言者也", "出議論", "退之節", "玄光", "梓宮", "知由單", "占偶書", "世而後", "於怠惰", "水風", _
            "如翻", "一境", "官封", "常處", "于意散", "散失", "如拾", "足居", "足堂", "發疾", VBA.ChrW(-10157) & VBA.ChrW(-8395) & "疾", "偏於", "得做", "而難", "及哉", "以肆", "天下謂", "天下，謂", "偏于", "失則", "子而", "流於委", "肩輿", "以生怨", "以汗澤", "為求福", "為肉黍", "則學者將", "位之說", "為黍肉", "以及難", "其惡", "事爾", "但不香", "於移奪者", "知而不知", "舊榜", "得汩沒", "子所作", "易生粉", "發酸", "如燎毛", "置其次", "至沮喪", "驚也", "其為君之", "以不和", "以有比", "其為臣之", "所見者提", "居鄒下")
        
        dict.Add "周易", Array("癡")
        dict.Add "卦", Array("陣", "橋", "建築")
        dict.Add "筮", Array("仕")
        dict.Add "乾", Array("淨", "隆", "谿", "寧", "淳", "祐", "餱", "土", "屎", "紫黑", _
            "道初", "道元年", "道二年", "道三年", "道四年", "道五年", "道七月", _
            "坤分得聖", "和中", "枯", "坤清泰", "坤之清氣", "鵲", "闕一" & VBA.ChrW(-28146) & "金", "皋", VBA.ChrW(-32273))
        dict.Add "乾坤", Array("陷吉人", "清泰", "之清氣", "手", "分得聖")
        dict.Add "豫", Array("章", "讓", "撫", "王", "瞻", "兮若", "則立", "州", "暇", "知", "劇", "備", VBA.ChrW(20675), "防", "聞", "樟", "憂思", VBA.ChrW(13529) & "事", "凶事", _
            "先要", "豫為言之", "豫" & VBA.ChrW(29234) & "言之", "并宜", "子", "卜地", "且之", "且得")
        ...
        dict.Add "蹇", Array("諤", "驢", "叔", "氏", "周", "淺", "序辰", "材望", "毅然", "已莫", "步", "吃", "駝", "羝")
        dict.Add "渙", Array("然", "散", "遂踰", "指陳是", "贓污")
        dict.Add VBA.ChrW(28067), Array("然", "散", "遂踰", "指陳是", "贓污")
        dict.Add "夬", Array("切")
        
        dict.Add "頤", Array("和園", "正叔", "字正", "茂叔", "字茂", "指氣使", "庵", "菴", "盦", "谷", "下有皮", "所以不", "道德", "之見知", "之司", "之門", "兄弟", "之學", "之行", "其後十有餘", "之經", "草茅", "相知", "在經")
        dict.Add VBA.ChrW(-26587), Array("和園", "正叔", "字正", "茂叔", "字茂", "指氣使", "庵", "菴", "盦", "谷", "下有皮", "所以不", "道德", "之見知", "之司", "之門", "兄弟", "之學", "之行", "其後十有餘", "之經", "草茅", "相知", "在經")
        ...
        dict.Add "蠱", Array("惑人心", "蕩", "於心", "自埋", "之詐", "實生子", "毒", "發膨", "主", "之屬", "有鬼", "不絕", "者是也", "嫩", VBA.ChrW(23280), "脹", "皆中人", "惑之疾", "則中風")
        ...
        dict.Add "大有", Array("功", "力", "病", "父風", "警省", "逕庭", "李僧", "所瀦", "事在", "大積", "稽驗", "以畏服", "工夫", "裨益", "逕庭", "懽")
        
        dict.Add "無妄", Array("想", "減妄")
        dict.Add VBA.ChrW(26080) & "妄", Array("想", "減妄")
        dict.Add VBA.ChrW(26080) & VBA.ChrW(-10171) & VBA.ChrW(-8522), Array("想", "減妄")
        ...
        dict.Add "知幾", Array("為師", "挈", "為人", "試", "千古")
...
Property Get 易學KeywordsToMark_Exam_InPhrase_Avoid() As Scripting.Dictionary
    If inPhrase_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("李易安", "居易錄", "蘇易簡", "杜易簡", "張易之", "此易事", "人易老", "人易去", "兩易其任", "最易淆", "以賢易不肖", "以治易亂", _
            "江山易主", "深耕易耨", "賢易色", "與其易也", "周易癡", "豈易得", "改易也", "豈易逢", "君子易事", "竇易直", "小易大", "後易為", "此易彼", "不以易其", "得而易失", "人而易私", "人而易" & VBA.ChrW(-10155) & VBA.ChrW(-8352), "以易此", "無以易也", "延易府", "皮易布", "金易一", "名易知", "雖易得", "誠至易", "則易束", "者易窺", "置易制", "難、易相", "事易行", "不易之", "今易以冠服", "俱易以", "易知也", "市易法", "可以易一飽", "賈易不", "和易之氣", "氣易壅", "心易放", "躁而易遷", "淺而易洩", _
            "而易見", "乃為易見", "或易言之", "然易見", "而易起", "簡而易行", "而易晦", "以羊易之", "請易之", "羊易牛", "足以易之", "多易之", "公易其介", "不能易也", "最易得", "其情易見", "亢易招", "以易鹽米", "頓易故", "谿易雨", "者易訓", "心易偏", "平心易氣", "故其說易差", "始易為力", "乃易合", "而易彼", "慢而易之", "而易治", "樂易之", "視而易之", "邪正易位", "最易牽引", _
            "猶易檢點", "言易入", "其得易失", "以易之也", "以易心", "而易操", "病易見", "實易行", "無以易之", "誰以易之", "豈易及", "以易處之", "則易從", "未之能易也", "又易入", "既易知", "先其易者", "先易後難", "則易位", "反易天明", "淺近易見", "因易其韻", "以縉儒者易之", "因改易本文而", "尺寸易以", "客易主位", "願亦易愜", "則易發", "根易發", "客易位", "以改易之", "主易位", "必易疑", "易信必易疑", "平實易知", "簡要易行", "而易流", _
            "傷易則誕", "而易陵", "最易散", "皆易之以", "失易見", "欲易之", "事在易而求", "儉則易足", "過易辭", "惑易解", "為易入", "所有易其", "可以易位", "曾易占", "欲易足", "不能易焉", "深德易占", "後易占", "將易吾", "者易犯", "狹則易足", "悔易勿輕踵", "智易窮", "何以易窮", "更有易見者", "而易散", "道易明", "教易行", _
            "至易事", "以道易之", "甚易解", "和易以思", "火易動", "較易做", "遠利而易以仁義", "而易行", "味易過", "得到易處", "曉然易見", "乃易見也", "亦易記", "功易事", "喪易而文", "言易色", "言之易耶", "易位易君", "得而易者", "有易畏", "而易知", "改柯易葉", "敢易也", "河東、易定", "易定、魏博", "豈易堪此", "以為易知", "河東易定", "脆易折", "彰癉易位", "易定魏博", "柔易治", "最易生", _
            "今易置于", "疾易作", "而易動", "則易字", "粟易之", "病易除", "氣易動", "互易注文", "長易見", "其易寧戚", "然易判", "陋易見", "其易，寧", "而易昏", "敬易之", "而易奪", "無難，是以易也", "人易從", "何以易生", "易放而難操", "氣易乘", "直易行", "其易趣", "物亦易給", "錢差易 ", "言易墜", "所以易放", "者易直", "是易言也", "須易之", "之易以仰測", "蓴絲之易", "皆易黃屋", "皆易" & ChrW(-24892) & "屋", "時易以新", _
            ...
            "因易名曰", "易見易除", "以字易名", "別易一人", "放言易故", "亂易亂", "婿易見", "壤易處", "信易食", "信易生", "小則易足", "足則無", "合而易離", VBA.ChrW(22779) & "易見", "所賤易所貴", "敢易乎", "食而易得", "籠易制", "去之易也", "仁民易而", "差錯故易說", "差錯，故易說", "論人易矣", "故易辨也", "不易長", "惡幾易熾", "和易近人", "以日易月", "至易而行難", "大樂必易", "以之易業", "以之易用", "不欲易也", "基而易舊", _
            "以為易為人", "充者易見", "忿易以懲", "深易以極", "心易以生", "則易入於", "皆易與之", "道易行", "王易王", "霸易霸", "死易不義", "原易范", "鐵易土", "德易勉", "兵易進", "亦易退", "實而易虛", "江易舟", "苦于易奪", "傷于易敗", "相信，易以成功", _
        ...
        dict.Add "豫", Array("事豫則", "康哉豫矣", "人豫知", "而豫求", "能豫逆", "豫射其", "於豫圖", "豫州。豫。舒也", "故豫戒之", "以豫為先", "而豫待", "訪豫且")
        dict.Add "蹇", Array("剛蹇絕", "歲蹇剝", "辭以蹇字", "驕蹇之心", "罹蹇難", "忠蹇之")
        
        dict.Add "頤", Array("龔頤正", "翁頤昌", "方頤大口", "解頤撫掌", "兩頤間", "解頤而悅", "曾與頤言")
        dict.Add VBA.ChrW(-26587), Array("龔" & VBA.ChrW(-26587) & "正", "翁" & VBA.ChrW(-26587) & "昌", "方" & VBA.ChrW(-26587) & "大口", "解" & VBA.ChrW(-26587) & "而悅", "曾與頤言")
        
        dict.Add "暌", Array("有暌談笑")
        dict.Add "蠱", Array("以蠱留人", "以蠱而", "而蠱者", "以蠱大", "中蠱者", "內蠱豔", "為蠱惑")
        dict.Add "萃", Array("檀萃文", "陽萃焉")
        dict.Add "賁", Array("古賁灰", "隸書賁字", "廣賁之", "苗賁皇", "增賁之")
