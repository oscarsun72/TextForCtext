...
Property Get 易學KeywordsToMark_Exam_Followed_Avoid() As Scripting.Dictionary
    If followed_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("簀", "牙", "之以書契", "安居士", "幟", "轍", "退", "厭", "水", "州", "順鼎", "破", "開罐", "筋", "姓", "名之日", "卜生", "堂", "科", _
            ...
            "如翻", "官封", "常處", "如拾", "足居", "足堂", "發疾", VBA.ChrW(-10157) & VBA.ChrW(-8395) & "疾", "偏於", "得做", "而難", "及哉", "以肆", "天下謂", "天下，謂", "偏于", "失則", "子而", "流於委", "肩輿", "以生怨", "以汗澤", "為求福", "為肉黍", "則學者將", "位之說", "為黍肉", "以及難", "其惡", "事爾", "但不香", "於移奪者", "知而不知", "舊榜", "得汩沒", "子所作", "易生粉", "發酸", "如燎毛", "置其次", "至沮喪", "驚也", "其為君之", "以不和", "以有比", "其為臣之", "所見者提", "居鄒下")
        ...
        dict.Add "乾", Array("淨", "隆", "谿", "寧", "淳", "祐", "餱", "土", "屎", "紫黑", _
            ...
            "和中", "枯", "坤清泰", "坤之清氣", "鵲", "闕一" & VBA.ChrW(-28146) & "金", "皋", VBA.ChrW(-32273))
        dict.Add "乾坤", Array("陷吉人", "清泰", "之清氣", "手")
...
Property Get 易學KeywordsToMark_Exam_InPhrase_Avoid() As Scripting.Dictionary
    If inPhrase_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("李易安", "居易錄", "蘇易簡", "杜易簡", "張易之", "此易事", "人易老", "人易去", "兩易其任", "最易淆", "以賢易不肖", "以治易亂", _
            ...
            "傷易則誕", "而易陵", "皆易之以", "失易見", "欲易之", "事在易而求", "儉則易足", "過易辭", "惑易解", "為易入", "所有易其", "可以易位", "曾易占", "欲易足", "不能易焉", "深德易占", "後易占", "將易吾", "者易犯", "狹則易足", "悔易勿輕踵", "智易窮", "何以易窮", "更有易見者", "而易散", "道易明", "教易行", _
