...
Property Get 易學KeywordsToMark_Exam_Preceded_Avoid() As Scripting.Dictionary
    If preceded_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("尤", "容", "未", "不", "極", "甚", "貿", "交", "物", "變", "或可", "鄙", "博", "辟", "平", "慢", "竄", "俗", "坦", "難", "脫", "流", "樂", "革", "更", "簡", "白居", "居", "淺", "輕", "險", "相", "難行", "世", "易", "所", _
            "移", "狂", "平仄相", "遂", "每歲一", "錢", "涿", "卻", "躁", VBA.ChrW(21364), VBA.ChrW(-10143) & VBA.ChrW(-8533), "傳寫之便", "光庭、賈", "光庭賈", "為人和", "辟", "驕", "一氣一", "資和", _
            "丘不與", "不足以", "以粟", "起而不與", "新陳相", "躐", "捷最", "上下互", "難而", "無諂", "肯改", "崔伯", "劉", "奢", "覆墜之", "不能", "知其難", "得失之", "有不善未嘗不知", "事難慮", "事久則慮", "勢固", "立門戶也", "立門" & VBA.ChrW(25143) & "也", _
            "聽之者", "壞真從", "喪失之", "為惡則", "言兮毋", "則忘之", "成材也", "不察則", "可得而", "尋又", "愉和", "壞" & VBA.ChrW(30494) & "從", "厚和", "誠不為", "可", "人欲", "市", "輒", VBA.ChrW(-28903), "遽", "過於和", "平心", "大樂必", _
            "切磋之功", VBA.ChrW(-10175) & VBA.ChrW(-8614) & "富", "處富", "忽其", "於我之", "弗抑則", "君便道", "知其至", "反復於其", "立節行、", "非難非", "求信則", "無身過", "順而", "不敢以", "其來之", "非心", "至之亦", "無口過", "甚順且", "心便", "其正外", "盜固", "立節行", "圖難於其", "成誦", "月日時無", "使聽者之", "嶽號五", "鮮不忽", "而外和", "致終身之", "以天下與人", "詰王與", "未達之所守", "實理自然故", "之久而續之")
            
        dict.Add "乾", Array("白", "涸", "豆", "衣", "面自", "擰", "餅", "未", "晾", "肉", "蘿蔔", "葡萄", "龍眼", "口", "枯", "烘", "晒", "曬", "筍", "外強中", "暴之")
    ...
    If followed_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("簀", "牙", "之以書契", "安居士", "幟", "轍", "退", "厭", "水", "州", "順鼎", "破", "開罐", "筋", "姓", "名之日", "卜生", "堂", "科", _
            "守", "棺", "看", "積", "容", "衣", "折", "萌", "葬", "獄", "敗", "壞", VBA.ChrW(22730), "其處", "汙", "污", "名者", "曉", "得消散", "慢", "熔", "忘", "物", "易", "俗", "差", "陷", "肆", "下手", "渡", "紙易之", "腐敗", _
             "手", "粟", "直也", "如反", "地則", "事者", "地皆", "其言者", "進而", "其言而", "善作詩", "治也", "制伏", "樂者必多哀", "以成誦", "位之事", "直子諒", "察者", "學而", "著火", "於噴", "元善", "之以羊", "其田疇", "世之後", "以走險", "其氣", "不能堪", "直不足言", "以動人", "得鹵", "十姓", "易其形者為", "言則難", "視之", _
            "失於" & VBA.ChrW(30094), "為物誘", "搖而難", "動難安", "昏而難", "一民之", "君之位", "以惑", "其好色", "字希", "直慈良", "天常", "見者", "代而改", "於混亂", VBA.ChrW(24422) & "章", "彥章", "以挺", "於近者。非知言者也", "於近者非知言者也", "出議論", "退之節", "玄光", "梓宮", "知由單", "占偶書", "世而後", "於怠惰", _
        ...
        dict.Add "筮", Array("仕")
        dict.Add "乾", Array("淨", "隆", "谿", "寧", "祐", "餱", "土", _
            "道初", "道元年", "道二年", "道三年", "道四年", "道五年", "道七月", _
            "和中", "枯", "坤清泰", "坤之清氣", "鵲", "闕一" & VBA.ChrW(-28146) & "金")
        dict.Add "乾坤", Array("陷吉人", "清泰", "之清氣")
        dict.Add "豫", Array("章", "讓", "王", "瞻", "則立", "州", "暇", "知", "劇", "備", VBA.ChrW(20675), "防", "聞", "樟", "憂思", VBA.ChrW(13529) & "事", "凶事", _
            "先要", "豫為言之", "豫" & VBA.ChrW(29234) & "言之", "子", "卜地")
            
        dict.Add "剝", Array("落", "削", "民", "蝕", "泐", "啄", "棗", "苔", "其皮", "去腸", "人面", "婦人衣", "而取之", "春" & VBA.ChrW(-31631), "春蔥", "芋", "了一重")
        dict.Add VBA.ChrW(21093), Array("落", "削", "民", "蝕", "泐", "啄", "棗", "苔", "其皮", "去腸", "人面", "婦人衣", "而取之", "春" & VBA.ChrW(-31631), "春蔥", "芋", "了一重")
        ...
        dict.Add "賁", Array("赫", "隅之", "軍之將", "讀為僨", "字", "軍", "音奔")
...
Property Get 易學KeywordsToMark_Exam_InPhrase_Avoid() As Scripting.Dictionary
    If inPhrase_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("李易安", "居易錄", "蘇易簡", "杜易簡", "張易之", "此易事", "人易老", "人易去", "兩易其任", "最易淆", "以賢易不肖", "以治易亂", _
            ...
            "言易入", "其得易失", "以易之也", "以易心", "無以易之", "誰以易之", "豈易及", "以易處之", "則易從", "未之能易也", "又易入", "既易知", "先其易者", "先易後難", "則易位", "反易天明", "淺近易見", "因易其韻", "以縉儒者易之", "因改易本文而", "尺寸易以", "客易主位", "願亦易愜", "則易發", "根易發", "客易位", "以改易之", "主易位", "必易疑", "易信必易疑", "平實易知", "簡要易行", _
            "傷易則誕", "而易陵", "皆易之以", "失易見", "事在易而求", "儉則易足", "過易辭", "惑易解", "為易入", "所有易其", "可以易位", "曾易占", "欲易足", "不能易焉", "深德易占", "後易占", "將易吾", "者易犯", "狹則易足", "悔易勿輕踵", "智易窮", "何以易窮", "更有易見者", "而易散", _
            ...
            "疾易作", "而易動", "粟易之", "病易除", "互易注文", "長易見", "其易寧戚", "然易判", "陋易見", "其易，寧", "而易昏", "敬易之", "而易奪", "無難，是以易也", "人易從", "何以易生", "易放而難操", "氣易乘", "物亦易給", "錢差易 ", "言易墜", "所以易放", "者易直", "是易言也", "須易之", "之易以仰測", "蓴絲之易", "皆易黃屋", "皆易" & ChrW(-24892) & "屋", "時易以新", _
            ...
            "因易名曰", "易見易除", "以字易名", "放言易故", "亂易亂", "婿易見", "壤易處", "信易食", "信易生", "小則易足", "足則無", "合而易離", VBA.ChrW(22779) & "易見", "所賤易所貴", "敢易乎", "食而易得", "籠易制", "仁民易而", "差錯故易說", "差錯，故易說", "論人易矣", "故易辨也", "不易長", "惡幾易熾", "和易近人", "以日易月", "至易而行難", "大樂必易", "以之易業", "以之易用", "不欲易也", "基而易舊", _
            ...
            "豈易說", "人人易知", VBA.ChrW(-29176) & "易陵躐", "親切易見", "中庸者世之所謂易", "中庸者，世之所謂易", "長大則易語", "以為易，故以為", "以為易故以為", "者易親", "者易" & VBA.ChrW(30094), "何言之易也", "人易知焉", "華飾者易于近名", "則易以興起", "而其易明" & VBA.ChrW(-10175) & VBA.ChrW(-8614))
