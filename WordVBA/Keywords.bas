...
'    If followed_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("簀", "牙", "之以書契", "安居士", "幟", "轍", "厭", "水", "州", "順鼎", "破", "開罐", "筋", "姓", "名之日", "卜生", "堂", "科", _
            ...
            "如翻", "如拾", "子而", "肩輿", "為求福", "為肉黍", "為黍肉", "事爾", "但不香", "知而不知", "舊榜", "得汩沒", "子所作", "易生粉", "發酸", "如燎毛", "置其次")
        dict.Add "周易", Array("癡")
...
'    If inPhrase_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("李易安", "居易錄", "蘇易簡", "杜易簡", "張易之", "此易事", "人易老", "人易去", "兩易其任", _
            ...
            "疾易作", "病易除", "互易注文", "人易從", "何以易生", "易放而難操", "氣易乘", "錢差易 ", "言易墜", "所以易放", "者易直", "是易言也", "須易之", "之易以仰測", "蓴絲之易", "皆易黃屋", "皆易" & ChrW(-24892) & "屋", "時易以新", _
            "則易使", "謀易太子", "侮易承業", "成易具", "綿布易之", "布相易云", "浴易服", "惡易敗", "一易根", "荄於易地", _
            "因易名曰", "以字易名", "籠易制", "論人易矣", "故易辨也", "不易長", "和易近人", "以日易月", "大樂必易", "以之易業", "以之易用", "不欲易也", "基而易舊", _
