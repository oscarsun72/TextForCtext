...
Property Get 易學Keywords_ToMark() As Variant 'string()因為 Array Returns a Variant containing an array,所以不能寫成 as string()
    易學Keywords_ToMark = Array("易", "周易", "易經", "大易", "五經", "六經", "七經", "十三經", "蓍", _
        "卦", "節卦", "離卦", "臨卦", "屯蒙", "屯" & VBA.ChrW(-10132) & VBA.ChrW(-8313), "屯、蒙", "屯、" & VBA.ChrW(-10132) & VBA.ChrW(-8313), "乾卦", "坤卦", "訟卦", "師卦", "比卦", "履卦", "泰卦", "否卦", "謙卦", "隨卦", "觀卦", "復卦", "習坎", "離卦", "咸卦", "恆卦", "晉卦", "家人卦", "解卦", "損卦", "益卦", "升卦", "困卦", "井卦", "革卦", "鼎卦", "震卦", "漸卦", "豐卦", "旅卦", "節卦", _
        "爻", _
        ...
        "河圖", "洛書", "太極", "無極", "兩儀", _
            ...
            "彖", _
             "艮其背", "艮", "頤", "同人于宗", "同人", "坎", "中孚", "兌", VBA.ChrW(20817), VBA.ChrW(20810), "蠱", "姤", "巽", VBA.ChrW(14514), "剝", VBA.ChrW(21093), "遯世無悶", "遯世" & ChrW(26080) & "悶", "遯", "大壯", "明夷", "明" & VBA.ChrW(-10171) & VBA.ChrW(-8739), "小畜", "大畜", "萃", "蹇", "渙", VBA.ChrW(28067), "睽", "暌", "歸妹", "小過", "大有", "大過", "〈泰〉", "〈否〉", "〈損〉", "〈益〉", "〈屯", "蒙〉", VBA.ChrW(-10132) & VBA.ChrW(-8313) & "〉", "豫大", "豫", "〈旡妄〉", "〈復〉", "〈震〉", "〈需〉", _
            "老陰", "老" & VBA.ChrW(-27006), "老陽", "少陰", "少" & VBA.ChrW(-27006), "少陽", "繇辭", "繇詞", _
            "咎", "咸恒", "咸恆", "大衍", "咸之九五", "禴祭", "東鄰殺牛", "東" & VBA.ChrW(-26973) & "殺牛", "禴" & VBA.ChrW(-10155) & VBA.ChrW(-8630), "禴" & VBA.ChrW(-10131) & VBA.ChrW(-8268), _
        "無妄", VBA.ChrW(26080) & VBA.ChrW(-10171) & VBA.ChrW(-8522), VBA.ChrW(26080) & "妄", _
        "無咎", VBA.ChrW(26080) & "咎", "天咎", "允升", "屯其膏", "豐亨", "終難", "知幾其神", "有子考", "有子攷", "不易乎世", "不易乎" & VBA.ChrW(21323), "不易乎" & VBA.ChrW(19991), "不成乎名", "天一地二", "蒞眾", VBA.ChrW(-31867) & "眾", VBA.ChrW(-31867) & VBA.ChrW(-30650), "蒞" & VBA.ChrW(-30650), _
        "隨時之義", "庖有魚", "包有魚", "精義入神", "豶豕", "童牛", "承之羞", "雷在天上", "錫馬", "蕃庶", "晝日", "三接", "懲忿", "窒欲", "懲窒", "敬以直內", "義以方外", "迷後得主", "利西南", "品物咸章", "天下大行", "益動而", "日進無疆", "日進" & VBA.ChrW(26080) & "疆", "頻巽", "頻" & VBA.ChrW(14514), "豚魚", "頻復", "閑邪", "存誠", "乾乾", "悔吝", "憧憧", "類萬物", VBA.ChrW(-10139) & VBA.ChrW(-8938) & "萬物", VBA.ChrW(-10139) & VBA.ChrW(-8937) & "萬物", "柔順利貞", VBA.ChrW(-10163) & VBA.ChrW(-9167) & "順利貞", "比之匪人", "履貞", "貞厲", "履道坦坦", "貞吉", "直方", "木上有水", "勞民勸相", "索而得", "貞不字", _
        ...
        "大貞", "小貞", "帝出乎震", "帝出於震", "帝出于震", "與時偕行", "盈虛", "盈" & VBA.ChrW(-31142), "盈" & VBA.ChrW(-10119) & VBA.ChrW(-8991), "盈" & VBA.ChrW(-31145), "履霜", _
        "天在山中", "多識前言往行", "蹇蹇", "匪躬", "匪" & VBA.ChrW(-29005), "洗心", "龍德", "慎言語", VBA.ChrW(24892) & "言語", "節飲食", _
...
Property Get 易學KeywordsToMark_Exam_Preceded_Avoid() As Scripting.Dictionary
    ...
    dict.Add "渙", Array("崔", "蘇", "程", "畔", "本作", "士", "黃", VBA.ChrW(-24892), "謁", "濉", "王")
    dict.Add VBA.ChrW(28067), Array("崔", "蘇", "程", "畔", "本作", "士", "黃", VBA.ChrW(-24892), "謁", "濉", "王")
