...
Dim zhouyiguaShapeNameSequence As Scripting.Dictionary
Dim zhouyiguaNameShapeSequence As Scripting.Dictionary
Dim preceded_Avoid As Scripting.Dictionary
Dim followed_Avoid As Scripting.Dictionary
Dim inPhrase_Avoid As Scripting.Dictionary
...
Property Get 易學Keywords_ToMark() As Variant 'string()因為 Array Returns a Variant containing an array,所以不能寫成 as string()
    易學Keywords_ToMark = Array("易", "周易", "易經", "大易", "五經", "六經", "七經", "十三經", "蓍", _
        ...
        "初九", "九二", "九三", "九四", "九五", "上九", VBA.ChrW(19972) & "九", "用九", "初六", "六二", "六三", "六四", "六五", "上六", "用六", "河圖", "洛書", "太極", "無極", "兩儀", _
            "象曰", "〈象〉曰", "象日", "象云", "象傳", "大象", "大" & VBA.ChrW(-10145) & VBA.ChrW(-9156), "小象", "象義", "四象", VBA.ChrW(-10145) & VBA.ChrW(-9156), "象：", "象文", "彖", _
        ...
        "隨時之義", "庖有魚", "包有魚", "精義入神", "豶豕", "童牛", "承之羞", "雷在天上", "錫馬", "蕃庶", "晝日", "三接", "懲忿", "窒欲", "懲窒", "敬以直內", "義以方外", "迷後得主", "利西南", "品物咸章", "天下大行", "益動而", "日進無疆", "日進" & VBA.ChrW(26080) & "疆", "頻巽", "頻" & VBA.ChrW(14514), "豚魚", "頻復", "閑邪", "存誠", "乾乾", "悔吝", "憧憧", "類萬物", VBA.ChrW(-10139) & VBA.ChrW(-8938) & "萬物", VBA.ChrW(-10139) & VBA.ChrW(-8937) & "萬物", "柔順利貞", VBA.ChrW(-10163) & VBA.ChrW(-9167) & "順利貞", "比之匪人", "履貞", "貞厲", "履道坦坦", "貞吉", "直方", "木上有水", "勞民勸相", "索而得", "貞不字", "立成器", "與地之", _
        "無悶", VBA.ChrW(26080) & "悶", "悔亡", "悔" & VBA.ChrW(20158), "悔" & VBA.ChrW(20838), "時義", "健順", "內健而外順", "內健外順", "外順而內健", "外順內健", "易簡", "易" & VBA.ChrW(-10153) & VBA.ChrW(-9007), "敦復", "開物成務", "窮神知化", "研幾極深", "極深研幾", "見善則遷", "有過則改", "遷善改過", "夕惕", "惕若", "一陰一陽", "我有好爵", "言有序", "有聖人之道四", "長子帥師", "弟子輿尸", "日用而不知", "之道鮮", "原始反終", "寂然不動", "感而遂通", "朋從", "朋盍", "容民畜眾", "容民畜" & VBA.ChrW(-30650), "養正", "養賢", "知臨", "臨大君", "默而成之", VBA.ChrW(-24871) & "而成之", "不言而信", "存乎德行", "通天下之志", "履正", "繼之者善", "仁者見之", "知者見之", "智者見之", _
        "大貞", "小貞", "帝出乎震", "帝出於震", "帝出于震", "與時偕行", "盈虛", "盈" & VBA.ChrW(-31142), "盈" & VBA.ChrW(-10119) & VBA.ChrW(-8991), "盈" & VBA.ChrW(-31145), "履霜", "艮其限", "乃孚", _
        "天在山中", "多識前言往行", "蹇蹇", "匪躬", "匪" & VBA.ChrW(-29005), "洗心", "龍德", "慎言語", VBA.ChrW(24892) & "言語", "節飲食", "改命吉", VBA.ChrW(25914) & "命吉", _
        "賁於丘園", "賁于丘園", "賁於邱園", "賁于邱園", "賁於" & VBA.ChrW(-10176) & VBA.ChrW(-9207) & "園", "賁于" & VBA.ChrW(-10176) & VBA.ChrW(-9207) & "園", "先天後天", _
        "賁於" & VBA.ChrW(-10176) & VBA.ChrW(-9204) & "園", "賁于" & VBA.ChrW(-10176) & VBA.ChrW(-9204) & "園", "賁於" & VBA.ChrW(-10143) & VBA.ChrW(-8559) & "園", "賁于" & VBA.ChrW(-10143) & VBA.ChrW(-8559) & "園", "鞏用", _
        "束帛戔戔", "損下以益上", "損下益上", "損下而益上", "貳用缶", "納約自牖", "利見大人", "何思何慮", "同歸而殊塗", "一致而百慮", "同歸殊塗", "一致百慮", "精氣為物", "者其辭", _
...
Property Get 易學KeywordsToMark_Exam_InPhrase_Avoid() As Scripting.Dictionary
    If inPhrase_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("李易安", "居易錄", "蘇易簡", "杜易簡", "張易之", "此易事", "人易老", "人易去", "兩易其任", _
            "江山易主", "深耕易耨", "周易癡", "豈易得", "豈易逢", "君子易事", "竇易直", "後易為", "此易彼", "得而易失", "人而易私", "人而易" & VBA.ChrW(-10155) & VBA.ChrW(-8352), "以易此", "無以易也", "延易府", "皮易布", "金易一", "名易知", "雖易得", "誠至易", "則易束", "者易窺", "置易制", "難、易相", "事易行", "今易以冠服", "俱易以", "易知也", "市易法", "可以易一飽", "賈易不", "和易之氣", _
            ...
            "疾易作", "病易除", "人易從", "何以易生", "易放而難操", "錢差易 ", "言易墜", "所以易放", "者易直", "是易言也", "須易之", "之易以仰測", "蓴絲之易", "皆易黃屋", "皆易" & ChrW(-24892) & "屋", "時易以新", _
        ...
        dict.Add "乾", Array("大乾廟", "乳乾者", "雨乾時", "五季乾坤")
