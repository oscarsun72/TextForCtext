...
Property Get 易學KeywordsToMark_Exam_Followed_Avoid() As Scripting.Dictionary
    If followed_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("簀", "牙", "之以書契", "安居士", "幟", "轍", "退", "厭", "水", "州", "順鼎", "破", "開罐", "筋", "姓", "名之日", "卜生", "堂", "科", _
            ...
            "如翻", "官封", "常處", "于意散", "散失", "如拾", "足居", "足堂", "發疾", VBA.ChrW(-10157) & VBA.ChrW(-8395) & "疾", "偏於", "得做", "而難", "及哉", "以肆", "天下謂", "天下，謂", "偏于", "失則", "子而", "流於委", "肩輿", "以生怨", "以汗澤", "為求福", "為肉黍", "則學者將", "位之說", "為黍肉", "以及難", "其惡", "事爾", "但不香", "於移奪者", "知而不知", "舊榜", "得汩沒", "子所作", "易生粉", "發酸", "如燎毛", "置其次", "至沮喪", "驚也", "其為君之", "以不和", "以有比", "其為臣之", "所見者提", "居鄒下")
...
Property Get 易學KeywordsToMark_Exam_InPhrase_Avoid() As Scripting.Dictionary
    If inPhrase_Avoid Is Nothing Then
        ...
        dict.Add "易", Array("李易安", "居易錄", "蘇易簡", "杜易簡", "張易之", "此易事", "人易老", "人易去", "兩易其任", "最易淆", "以賢易不肖", "以治易亂", _
            ...
            "言易入", "其得易失", "以易之也", "以易心", "而易操", "病易見", "實易行", "無以易之", "誰以易之", "豈易及", "以易處之", "則易從", "未之能易也", "又易入", "既易知", "先其易者", "先易後難", "則易位", "反易天明", "淺近易見", "因易其韻", "以縉儒者易之", "因改易本文而", "尺寸易以", "客易主位", "願亦易愜", "則易發", "根易發", "客易位", "以改易之", "主易位", "必易疑", "易信必易疑", "平實易知", "簡要易行", "而易流", _
