...
>>>今加入Copilot大菩薩提到的 Console.CapsLock 屬性來判斷似乎精準多了！好像還是會掛 ：D 也有不靈光時 >o<"" 還是啟動 cmd.exe 的方式最穩健 感恩感恩　讚歎讚歎　南無阿彌陀佛　讚美主
...
Alt + Shift + r ：將夾注文本錯亂倒置者重整，如「{{雪電}}　{{雨霧}}　{{霽虹}}　{{雷}}」這樣的文本，改成「{{雪􏿽雨􏿽霽􏿽雷、電􏿽霧􏿽虹　　}}」
